...
#ifndef __CHROMATIX_SHARPEN_kirin970_H__
#define __CHROMATIX_SHARPEN_kirin970_H__
...
typedef struct _arsr_sharpen_manual_cfg_t
{
    unsigned int use_manual;
    arsr_reg_filter_t     arsr_reg_filter;
    ...
    unsigned int     arsr_slope;
    unsigned int     arsr_offset_max;
    unsigned int  anti_aliasing_en;
}arsr_sharpen_manual_cfg_t;
