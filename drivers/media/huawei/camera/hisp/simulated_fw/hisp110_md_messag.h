...
/* optical zoom flag for barca when the depth is bigger than 50cm */
typedef struct
{
    int             af_optical_zoom_flag;
    float           af_optical_zoom_depth;
} af_optical_zoom_info_t;
...
typedef struct
{
    ...
    unsigned int            aux_af_ctrl_cur_code;
    unsigned int            af_ctrl_cur_virtual_code;
    unsigned int            aux_af_ctrl_cur_virtual_code;
    signed long long        af_ctrl_focus_done_time;
    unsigned int            vcm_stable;
    unsigned int            aux_vcm_stable;
    unsigned int            hw_ipp_vcm_stable;
    unsigned int            aux_hw_ipp_vcm_stable;
    ...
    af_md_detailed_info_t   aux_af_detailed_info;
    ...
    int                     aux_pointFlag;
    char                    af_sensor_temp;
    char                    aux_af_sensor_temp;
    char                    af_driver_temp;
    char                    aux_af_driver_temp;
    af_optical_zoom_info_t  af_optical_zoom_info;
    int                     reserved[11];
