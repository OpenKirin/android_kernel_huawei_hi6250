...
struct sensor_power_setting hw_ov13850_power_up_setting[] = {
...
struct sensor_power_setting hw_ov13850_power_down_setting[] = {
    {
        .seq_type = SENSOR_RST,
        .config_val = SENSOR_GPIO_LOW,
        .sensor_index = SENSOR_INDEX_INVALID,
...
static sensor_t s_ov13850 =
{
    ...
    .power_setting_array = {
            .size = ARRAY_SIZE(hw_ov13850_power_up_setting),
            .power_setting = hw_ov13850_power_up_setting,
     },
    .power_down_setting_array = {
            .size = ARRAY_SIZE(hw_ov13850_power_down_setting),
            .power_setting = hw_ov13850_power_down_setting,
    },
...
int ov13850_power_up(hwsensor_intf_t* si)
{
    ...
    ret = hw_sensor_power_up_config(s_ov13850.dev, sensor->board_info);
    if (0 == ret )
    {
