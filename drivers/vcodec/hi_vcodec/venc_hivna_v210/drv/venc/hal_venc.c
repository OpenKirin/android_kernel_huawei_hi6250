...
extern VeduEfl_SMMU_ERR_RW_ADDR g_smmu_err_mem;
...
HI_VOID VeduHal_CfgReg_AddrSet(VENC_REG_INFO_S *channelcfg)
{
	...
	//ԭʼͼ��Stride��Ϣѹ���ͷ�ѹ������һ�����ñ���
	{
		pAllReg->VEDU_VCPI_STRIDE.u32   =   channelcfg->all_reg.VEDU_VCPI_STRIDE.u32;
	}
	HI_DBG_VENC("HAl ADDRSet,pEncPara_channel->VEDU_VCPI_SRC_YADDR=%x\n",channelcfg->all_reg.VEDU_VCPI_SRC_YADDR);
	HI_DBG_VENC("HAl ADDRSet,pEncPara_channel->VEDU_VCPI_SRC_CADDR=%x\n",channelcfg->all_reg.VEDU_VCPI_SRC_CADDR);
	HI_DBG_VENC("HAl ADDRSet,pEncPara_channel->VEDU_VCPI_SRC_VADDR=%x\n",channelcfg->all_reg.VEDU_VCPI_SRC_VADDR);
	HI_DBG_VENC("HAl ADDRSet,pEncPara_channel->vcpi_curld_c_stride=%x\n",channelcfg->all_reg.VEDU_VCPI_STRIDE.bits.vcpi_curld_c_stride);
	HI_DBG_VENC("HAl ADDRSet,pEncPara_channel->vcpi_curld_y_stride=%x\n",channelcfg->all_reg.VEDU_VCPI_STRIDE.bits.vcpi_curld_y_stride);
	/*if(channelcfg->all_reg.VEDU_VCPI_STRFMT.bits.vcpi_str_fmt == 10)
	{
		...
		HI_DBG_VENC("HAl ADDRSet,channelcfg->all_reg.VEDU_VCPI_CH_ADDR=%x\n",channelcfg->all_reg.VEDU_VCPI_YH_ADDR);
		HI_DBG_VENC("HAl ADDRSet,channelcfg->all_reg.VEDU_VCPI_CH_ADDR=%x\n",channelcfg->all_reg.VEDU_VCPI_CH_ADDR);
		HI_DBG_VENC("HAl ADDRSet,channelcfg->all_reg.vcpi_curld_srcch_stride=%x\n",channelcfg->all_reg.VEDU_CURLD_SRCH_STRIDE.bits.vcpi_curld_srcch_stride);
		HI_DBG_VENC("HAl ADDRSet,channelcfg->all_reg.vcpi_curld_srcyh_stride=%x\n",channelcfg->all_reg.VEDU_CURLD_SRCH_STRIDE.bits.vcpi_curld_srcyh_stride);
		//HI_INFO_VENC("HAl ADDRSet,pEncPara_channel->vcpi_curld_hfbcd_bypass_en=%x\n",pEncPara->vcpi_curld_hfbcd_bypass_en);
		//HI_INFO_VENC("HAl ADDRSet,pEncPara_channel->vcpi_curld_hfbcd_raw_en=%x\n",pEncPara->vcpi_curld_hfbcd_raw_en);
	}*/
	...
	pAllReg->VEDU_VCPI_REFC_L0_ADDR   =   channelcfg->all_reg.VEDU_VCPI_REFC_L0_ADDR;
	{
		...
		HI_DBG_VENC("DRV_RefYUV_MD5_NEW--------ystride =%x,cstride =%x\n",pAllReg->VEDU_VCPI_REF_L0_STRIDE.bits.vcpi_refy_l0_stride,pAllReg->VEDU_VCPI_REF_L0_STRIDE.bits.vcpi_refc_l0_stride);
	}
#if 0
	...
	pAllReg->VEDU_VCPI_REFC_L1_ADDR   =   channelcfg->all_reg.VEDU_VCPI_REFC_L1_ADDR;//pEncPara_channel->VEDU_REFC_L1_ADDR;
	{
		...
		HI_DBG_VENC("DRV_RefYUV_MD5_NEW--------ystride =%x,cstride =%x\n",pAllReg->VEDU_VCPI_REF_L1_STRIDE.bits.vcpi_refy_l1_stride,pAllReg->VEDU_VCPI_REF_L1_STRIDE.bits.vcpi_refc_l1_stride);
	}
...
HI_VOID VeduHal_CfgReg_SlcHeadSet(VENC_REG_INFO_S *channelcfg)
{
	...
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->slchdr_size_part2=%x\n",pEncPara_channel->slchdr_size_part2);
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->CABAC_SLCHDR_PART2_SEG[0]=%x\n",pEncPara_channel->CABAC_SLCHDR_PART2_SEG[0]);
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->CABAC_SLCHDR_PART2_SEG[1]=%x\n",pEncPara_channel->CABAC_SLCHDR_PART2_SEG[1]);
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->CABAC_SLCHDR_PART2_SEG[2]=%x\n",pEncPara_channel->CABAC_SLCHDR_PART2_SEG[2]);
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->CABAC_SLCHDR_PART2_SEG[3]=%x\n",pEncPara_channel->CABAC_SLCHDR_PART2_SEG[3]);
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->CABAC_SLCHDR_PART2_SEG[4]=%x\n",pEncPara_channel->CABAC_SLCHDR_PART2_SEG[4]);
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->CABAC_SLCHDR_PART2_SEG[5]=%x\n",pEncPara_channel->CABAC_SLCHDR_PART2_SEG[5]);
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->CABAC_SLCHDR_PART2_SEG[6]=%x\n",pEncPara_channel->CABAC_SLCHDR_PART2_SEG[6]);
	//HI_INFO_VENC("HAl SlcHar,pEncPara_channel->CABAC_SLCHDR_PART2_SEG[7]=%x\n",pEncPara_channel->CABAC_SLCHDR_PART2_SEG[7]);
	...
	if (channelcfg->all_reg.VEDU_VLCST_PARAMETER.bits.vlcst_para_set_en == 1)
	{
		...
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA0:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA0);
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA1:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA1);
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA2:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA2);
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA3:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA3);
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA4:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA4);
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA5:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA5);
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA6:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA6);
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA7:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA7);
		HI_DBG_VENC("pAllReg->VLCST_PARA_DATA8:0x%x\n",pAllReg->VEDU_VLCST_PARA_DATA8);
...
HI_VOID VeduHal_CfgReg_SMMUSet(VENC_REG_INFO_S *channelcfg)
{
	...
	HI_DBG_VENC("phy_pgd_base:0x%lx\n",phy_pgd_base);
	HI_DBG_VENC("(phy_pgd_base >> 32):0x%x\n",(phy_pgd_base >> 32));
	//SMRX_0
	HI_DBG_VENC("%s,ADDR--SMMU_MSTR_GLB_BYPASS=%x,SMMU_SCR=%x,VCPI_INTMASK=%x\n", __func__,(&(pAllReg->SMMU_MSTR_GLB_BYPASS)),(&(pAllReg->SMMU_SCR)),(&(pAllReg->VEDU_VCPI_INTMASK)));
	//QOS
	...
	HI_DBG_VENC("SMMU_CB_TTBR0:%x, SMMU_FAMA_CTRL1_NS.bits.fama_ptw_msb_ns:%x, SMMU_CB_TTBCR.bits.cb_ttbcr_des :%x\n", pAllReg->SMMU_CB_TTBR0, pAllReg->SMMU_FAMA_CTRL1_NS[0].bits.fama_ptw_msb_ns, pAllReg->SMMU_CB_TTBCR.bits.cb_ttbcr_des);

	HI_DBG_VENC("%s,VALUE--SMMU_MSTR_GLB_BYPASS=%x,SMMU_SCR=%x,SMMU_CB_TTBR0=%x\n", __func__,pAllReg->SMMU_MSTR_GLB_BYPASS.bits.glb_bypass,pAllReg->SMMU_SCR.bits.glb_bypass,pAllReg->SMMU_CB_TTBR0);
	HI_DBG_VENC("%s,ADDR--pAllReg->SMMU_CB_TTBCR=%x,SEC=%x,VCPI_INTMASK=%x\n", __func__,(&(pAllReg->SMMU_CB_TTBCR)),pAllReg->MMU_PRE_GLB_SCR.bits.glb_scr,(&(pAllReg->VEDU_VCPI_INTMASK)));
	HI_DBG_VENC("%s,ADDR--pAllReg->SMMU_MSTR_SMRX_0[0]=%x\n",__func__,(&(pAllReg->SMMU_MSTR_SMRX_0[0])));
#if 1
	...
	{
		{
			for ( i = 0;i <48 ;i++)
			{
				...
				D32.bits.len= 0x1;
				 ...
				 pAllReg->SMMU_MSTR_SMRX_0[i].u32 = D32.u32;
				...
				D32.u32 = 0;
				D32.bits.smr_invld_en	= 0x1;
				D32.bits.smr_ptw_qos	= 0x3;
				D32.bits.smr_bypass = 0x0;

				 pAllReg->SMMU_SMRX_NS[i].u32 = D32.u32;
...
HI_VOID VeduHal_CfgReg_PREMMUSet(VENC_REG_INFO_S *channelcfg)
{
	...
	HI_DBG_VENC("%s,ADDR--MMU_PRE_NBI_MVST_ADDR_STR=%x,pAllReg->SMMU_MSTR_SMRX_1[0]=%x,pAllReg->MMU_PRE_STRMADDR0_STR=%x\n", __func__,(&(pAllReg->MMU_PRE_NBI_MVST_ADDR_STR)),(&(pAllReg->
					SMMU_MSTR_SMRX_1[0])),(&(pAllReg->MMU_PRE_STRMADDR0_STR)));
	HI_DBG_VENC("%s,ADDR--MMU_PRE_NBI_MVST_ADDR_STR=%x,pAllReg->SMMU_MSTR_SMRX_1[0]=%x,pAllReg->MMU_PRE_STRMADDR0_STR=%x\n", __func__,(&(pAllReg->MMU_PRE_NBI_MVST_ADDR_STR)),(&(pAllReg->
					SMMU_MSTR_SMRX_1[0])),(&(pAllReg->MMU_PRE_STRMADDR0_STR)));

	HI_DBG_VENC("%s,ADDR--MMU_PRE_NBI_MVST_ADDR_STR=%x,pAllReg->SMMU_MSTR_SMRX_2[0]=%x,pAllReg->MMU_PRE_STRMADDR0_STR=%x\n", __func__,(&(pAllReg->MMU_PRE_NBI_MVST_ADDR_STR)),(&(pAllReg->
					SMMU_MSTR_SMRX_2[0])),(&(pAllReg->MMU_PRE_STRMADDR0_STR)));
	//////PRE_ADDR
	...
	if (channelcfg->bFirstNal2Send)
	{
		...
		HI_DBG_VENC("pAllReg->MMU_PRE_PPS_ADDR_STR:0x%x pAllReg->MMU_PRE_PPS_ADDR_END:0x%x\n",pAllReg->MMU_PRE_PPS_ADDR_STR,pAllReg->MMU_PRE_PPS_ADDR_END);
	}
#endif
	...
	if(channelcfg->bSecureFlag == 1){ //sec
...
#endif
		//MISS Method No Need Setting
		//pAllReg->SMMU_MSTR_SMRX_1[38].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[38].bits.va_str;
		//pAllReg->SMMU_MSTR_SMRX_2[38].bits.va_end	=   channelcfg->all_reg.SMMU_MSTR_SMRX_2[38].bits.va_end;
	}
	else{
		pAllReg->SMMU_MSTR_SMRX_1[11].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[11].bits.va_str;
		pAllReg->SMMU_MSTR_SMRX_2[11].bits.va_end   =   channelcfg->all_reg.SMMU_MSTR_SMRX_2[11].bits.va_end;
		...
		//pAllReg->SMMU_MSTR_SMRX_1[14].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[19].bits.va_str;
		//pAllReg->SMMU_MSTR_SMRX_2[14].bits.va_end   =   (pEncPara_channel->VEDU_QPGLD_ADDR + pEncPara_channel->VEDU_QPGLD_Length -1)>>15;
		...
		//pAllReg->SMMU_MSTR_SMRX_1[21].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[19].bits.va_str;
		//pAllReg->SMMU_MSTR_SMRX_2[21].bits.va_end   =   (pEncPara_channel->VEDU_REFYH_L0_ADDR + pEncPara_channel->RcnYHeadLength -1)>>15;

		//pAllReg->SMMU_MSTR_SMRX_1[22].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[19].bits.va_str;
		//pAllReg->SMMU_MSTR_SMRX_2[22].bits.va_end   =   (pEncPara_channel->VEDU_REFCH_L0_ADDR + pEncPara_channel->RcnCHeadLength -1)>>15;
		...
		//pAllReg->SMMU_MSTR_SMRX_1[25].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[19].bits.va_str;
		//pAllReg->SMMU_MSTR_SMRX_2[25].bits.va_end   =   (pEncPara_channel->VEDU_SRC_YHADDR + pEncPara_channel->VEDU_SRC_YHLength -1)>>15;

		//pAllReg->SMMU_MSTR_SMRX_1[26].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[19].bits.va_str;
		//5pAllReg->SMMU_MSTR_SMRX_2[26].bits.va_end   =   (pEncPara_channel->VEDU_SRC_CHADDR + pEncPara_channel->VEDU_SRC_CHLength -1)>>15;
		...
		pAllReg->SMMU_MSTR_SMRX_1[31].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[31].bits.va_str;
		pAllReg->SMMU_MSTR_SMRX_2[31].bits.va_end   =   channelcfg->all_reg.SMMU_MSTR_SMRX_2[31].bits.va_end;
		//pAllReg->SMMU_MSTR_SMRX_1[42].bits.va_str   =   channelcfg->all_reg.;
		//pAllReg->SMMU_MSTR_SMRX_2[42].bits.va_end   =   channelcfg->all_reg.;
		//pAllReg->SMMU_MSTR_SMRX_1[43].bits.va_str   =   channelcfg->all_reg.;
		//pAllReg->SMMU_MSTR_SMRX_2[43].bits.va_end   =   channelcfg->all_reg.;
		pAllReg->SMMU_MSTR_SMRX_1[32].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[32].bits.va_str;
		pAllReg->SMMU_MSTR_SMRX_2[32].bits.va_end   =   channelcfg->all_reg.SMMU_MSTR_SMRX_2[32].bits.va_end;
		...
		//MISS Method No Need Setting
		//pAllReg->SMMU_MSTR_SMRX_1[47].bits.va_str   =   channelcfg->all_reg.SMMU_MSTR_SMRX_1[47].bits.va_str;
		//pAllReg->SMMU_MSTR_SMRX_2[47].bits.va_end   =   channelcfg->all_reg.SMMU_MSTR_SMRX_2[47].bits.va_end;
	}
#endif
...
HI_VOID VeduHal_CfgReg(VENC_REG_INFO_S *channelcfg)
{
	...
	HI_DBG_VENC("timeout:%d slice_end:%d buffull:%d\n",channelcfg->all_reg.VEDU_VCPI_INTMASK.bits.vcpi_enable_vedu_timeout,channelcfg->all_reg.VEDU_VCPI_INTMASK.bits.vcpi_enable_vedu_slice_end,channelcfg->all_reg.VEDU_VCPI_INTMASK.bits.vcpi_enable_ve_buffull);
	{
	...
	}
	{
		...
		//D32.bits.vcpi_rec_cmp_en = 1;
		D32.bits.vcpi_img_improve_en = 0;
...

	{
		...
		D32.bits.vcpi_force_intra_lowpwr_en 	= channelcfg->all_reg.VEDU_VCPI_LOW_POWER.bits.vcpi_force_intra_lowpwr_en;
...
#if 0
	{
		pAllReg->VEDU_VCPI_I_SLC_INSERT.u32   =   channelcfg->all_reg.VEDU_VCPI_I_SLC_INSERT.u32;
	}
#endif
...
#if 0  //K3V7 no need surport OSD fuction
	{
		U_VEDU_VCPI_OSD_ENABLE  D32;
		D32.bits.vcpi_osd0_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd0_en;
		D32.bits.vcpi_osd1_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd1_en;
		D32.bits.vcpi_osd2_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd2_en;
		D32.bits.vcpi_osd3_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd3_en;
		D32.bits.vcpi_osd4_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd4_en;
		D32.bits.vcpi_osd5_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd5_en;
		D32.bits.vcpi_osd6_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd6_en;
		D32.bits.vcpi_osd7_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd7_en;
		D32.bits.vcpi_osd0_absqp = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd0_absqp;
		D32.bits.vcpi_osd1_absqp = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd1_absqp;
		D32.bits.vcpi_osd2_absqp = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd2_absqp;
		D32.bits.vcpi_osd3_absqp = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd3_absqp;
		D32.bits.vcpi_osd4_absqp = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd4_absqp;
		D32.bits.vcpi_osd5_absqp = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd5_absqp;
		D32.bits.vcpi_osd6_absqp = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd6_absqp;
		D32.bits.vcpi_osd7_absqp = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd7_absqp;
		D32.bits.vcpi_roi_osd_sel_0 = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_roi_osd_sel_0;
		D32.bits.vcpi_roi_osd_sel_1 = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_roi_osd_sel_1;
		D32.bits.vcpi_roi_osd_sel_2 = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_roi_osd_sel_2;
		D32.bits.vcpi_roi_osd_sel_3 = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_roi_osd_sel_3;
		D32.bits.vcpi_roi_osd_sel_4 = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_roi_osd_sel_4;
		D32.bits.vcpi_roi_osd_sel_5 = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_roi_osd_sel_5;
		D32.bits.vcpi_roi_osd_sel_6 = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_roi_osd_sel_6;
		D32.bits.vcpi_roi_osd_sel_7 = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_roi_osd_sel_7;
		D32.bits.vcpi_osd_en = channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.vcpi_osd_en;
		pAllReg->VEDU_VCPI_OSD_ENABLE.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_ENABLE.u32;
	}

	{
		U_VEDU_VCPI_OSD_POS_0  D32;
		D32.bits.vcpi_osd0_x = channelcfg->all_reg.VEDU_VCPI_OSD_POS_0.vcpi_osd0_x;
		D32.bits.vcpi_osd0_y = channelcfg->all_reg.VEDU_VCPI_OSD_POS_0.vcpi_osd0_y;
		pAllReg->VEDU_VCPI_OSD_POS_0.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_POS_0.u32;
	}

	{
		U_VEDU_VCPI_OSD_POS_1  D32;
		D32.bits.vcpi_osd1_x = channelcfg->all_reg.VEDU_VCPI_OSD_POS_1.vcpi_osd1_x;
		D32.bits.vcpi_osd1_y = channelcfg->all_reg.VEDU_VCPI_OSD_POS_1.vcpi_osd1_y;
		pAllReg->VEDU_VCPI_OSD_POS_1.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_POS_1.u32;
	}

	{
		U_VEDU_VCPI_OSD_POS_2  D32;
		D32.bits.vcpi_osd2_x = channelcfg->all_reg.VEDU_VCPI_OSD_POS_2.vcpi_osd2_x;
		D32.bits.vcpi_osd2_y = channelcfg->all_reg.VEDU_VCPI_OSD_POS_2.vcpi_osd2_y;
		pAllReg->VEDU_VCPI_OSD_POS_2.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_POS_2.u32;
	}

	{
		U_VEDU_VCPI_OSD_POS_3  D32;
		D32.bits.vcpi_osd3_x = channelcfg->all_reg.VEDU_VCPI_OSD_POS_3.vcpi_osd3_x;
		D32.bits.vcpi_osd3_y = channelcfg->all_reg.VEDU_VCPI_OSD_POS_3.vcpi_osd3_y;
		pAllReg->VEDU_VCPI_OSD_POS_3.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_POS_3.u32;
	}

	{
		U_VEDU_VCPI_OSD_POS_4  D32;
		D32.bits.vcpi_osd4_x = channelcfg->all_reg.VEDU_VCPI_OSD_POS_4.vcpi_osd4_x;
		D32.bits.vcpi_osd4_y = channelcfg->all_reg.VEDU_VCPI_OSD_POS_4.vcpi_osd4_y;
		pAllReg->VEDU_VCPI_OSD_POS_4   =   channelcfg->all_reg.VEDU_VCPI_OSD_POS_4.u32;
	}

	{
		U_VEDU_VCPI_OSD_POS_5  D32;
		D32.bits.vcpi_osd5_x = channelcfg->all_reg.VEDU_VCPI_OSD_POS_5.vcpi_osd5_x;
		D32.bits.vcpi_osd5_y = channelcfg->all_reg.VEDU_VCPI_OSD_POS_5.vcpi_osd5_y;
		pAllReg->VEDU_VCPI_OSD_POS_5.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_POS_5.u32;
	}

	{
		U_VEDU_VCPI_OSD_POS_6  D32;
		D32.bits.vcpi_osd6_x = channelcfg->all_reg.VEDU_VCPI_OSD_POS_6.vcpi_osd6_x;
		D32.bits.vcpi_osd6_y = channelcfg->all_reg.VEDU_VCPI_OSD_POS_6.vcpi_osd6_y;
		pAllReg->VEDU_VCPI_OSD_POS_6.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_POS_6.u32;
	}

	{
		U_VEDU_VCPI_OSD_POS_7  D32;
		D32.bits.vcpi_osd7_x = channelcfg->all_reg.VEDU_VCPI_OSD_POS_7.vcpi_osd7_x;
		D32.bits.vcpi_osd7_y = channelcfg->all_reg.VEDU_VCPI_OSD_POS_7.vcpi_osd7_y;
		pAllReg->VEDU_VCPI_OSD_POS_7.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_POS_7.u32;
	}

	{
		U_VEDU_VCPI_OSD_SIZE_0  D32;
		D32.bits.vcpi_osd0_w = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_0.vcpi_osd0_w;
		D32.bits.vcpi_osd0_h = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_0.vcpi_osd0_h;
		pAllReg->VEDU_VCPI_OSD_SIZE_0.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_0.u32;
	}

	{
		U_VEDU_VCPI_OSD_SIZE_1  D32;
		D32.bits.vcpi_osd1_w = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_1.vcpi_osd1_w;
		D32.bits.vcpi_osd1_h = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_1.vcpi_osd1_h;
		pAllReg->VEDU_VCPI_OSD_SIZE_1.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_1.u32;
	}

	{
		U_VEDU_VCPI_OSD_SIZE_2  D32;
		D32.bits.vcpi_osd2_w = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_2.vcpi_osd2_w;
		D32.bits.vcpi_osd2_h = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_2.vcpi_osd2_h;
		pAllReg->VEDU_VCPI_OSD_SIZE_2.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_2.u32;
	}

	{
		U_VEDU_VCPI_OSD_SIZE_3  D32;
		D32.bits.vcpi_osd3_w = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_3.vcpi_osd3_w;
		D32.bits.vcpi_osd3_h = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_3.vcpi_osd3_h;
		pAllReg->VEDU_VCPI_OSD_SIZE_3.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_3.u32;
	}

	{
		U_VEDU_VCPI_OSD_SIZE_4  D32;
		D32.bits.vcpi_osd4_w = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_4.vcpi_osd4_w;
		D32.bits.vcpi_osd4_h = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_4.vcpi_osd4_h;
		pAllReg->VEDU_VCPI_OSD_SIZE_4.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_4.u32;
	}

	{
		U_VEDU_VCPI_OSD_SIZE_5  D32;
		D32.bits.vcpi_osd5_w = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_5.vcpi_osd5_w;
		D32.bits.vcpi_osd5_h = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_5.vcpi_osd5_h;
		pAllReg->VEDU_VCPI_OSD_SIZE_5.u32   =   channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_5.u32;
	}

	{
		U_VEDU_VCPI_OSD_SIZE_6  D32;
		D32.bits.vcpi_osd6_w = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_6.vcpi_osd6_w;
		D32.bits.vcpi_osd6_h = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_6.vcpi_osd6_h;
		pAllReg->VEDU_VCPI_OSD_SIZE_6.u32   =   channelcfg->all_reg..u32;
	}

	{
		U_VEDU_VCPI_OSD_SIZE_7  D32;
		D32.bits.vcpi_osd7_w = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_7.vcpi_osd7_w;
		D32.bits.vcpi_osd7_h = channelcfg->all_reg.VEDU_VCPI_OSD_SIZE_7.vcpi_osd7_h;
		pAllReg->VEDU_VCPI_OSD_SIZE_7.u32   =   channelcfg->all_reg..u32;
	}

	{
		U_VEDU_VCPI_OSD_LAYERID  D32;
		D32.bits.vcpi_osd0_layer_id = channelcfg->all_reg.VEDU_VCPI_OSD_LAYERID.vcpi_osd0_layer_id;
		D32.bits.vcpi_osd1_layer_id = channelcfg->all_reg.VEDU_VCPI_OSD_LAYERID.vcpi_osd1_layer_id;
		D32.bits.vcpi_osd2_layer_id = channelcfg->all_reg.VEDU_VCPI_OSD_LAYERID.vcpi_osd2_layer_id;
		D32.bits.vcpi_osd3_layer_id = channelcfg->all_reg.VEDU_VCPI_OSD_LAYERID.vcpi_osd3_layer_id;
		D32.bits.vcpi_osd4_layer_id = channelcfg->all_reg.VEDU_VCPI_OSD_LAYERID.vcpi_osd4_layer_id;
		D32.bits.vcpi_osd5_layer_id = channelcfg->all_reg.VEDU_VCPI_OSD_LAYERID.vcpi_osd5_layer_id;
		D32.bits.vcpi_osd6_layer_id = channelcfg->all_reg.VEDU_VCPI_OSD_LAYERID.vcpi_osd6_layer_id;
		D32.bits.vcpi_osd7_layer_id = channelcfg->all_reg.VEDU_VCPI_OSD_LAYERID.vcpi_osd7_layer_id;
		pAllReg->VEDU_VCPI_OSD_LAYERID.u32   =   channelcfg->all_reg..u32;
	}

	{
		U_VEDU_VCPI_OSD_QP0  D32;
		D32.bits.vcpi_osd0_qp = channelcfg->all_reg.VEDU_VCPI_OSD_QP0.vcpi_osd0_qp;
		D32.bits.vcpi_osd1_qp = channelcfg->all_reg.VEDU_VCPI_OSD_QP0.vcpi_osd1_qp;
		D32.bits.vcpi_osd2_qp = channelcfg->all_reg.VEDU_VCPI_OSD_QP0.vcpi_osd2_qp;
		D32.bits.vcpi_osd3_qp = channelcfg->all_reg.VEDU_VCPI_OSD_QP0.vcpi_osd3_qp;
		pAllReg->VEDU_VCPI_OSD_QP0.u32   =   channelcfg->all_reg..u32;
	}

	{
		U_VEDU_VCPI_OSD_QP1  D32;
		D32.bits.vcpi_osd4_qp = channelcfg->all_reg.VEDU_VCPI_OSD_QP1.vcpi_osd4_qp;
		D32.bits.vcpi_osd5_qp = channelcfg->all_reg.VEDU_VCPI_OSD_QP1.vcpi_osd5_qp;
		D32.bits.vcpi_osd6_qp = channelcfg->all_reg.VEDU_VCPI_OSD_QP1.vcpi_osd6_qp;
		D32.bits.vcpi_osd7_qp = channelcfg->all_reg.VEDU_VCPI_OSD_QP1.vcpi_osd7_qp;
		pAllReg->VEDU_VCPI_OSD_QP1.u32   =   channelcfg->all_reg..u32;
	}
#endif
	{
	...
	//�������Ϊѭ��BUFF,K3Ϊ��BUFF
	{
		pAllReg->VEDU_VCPI_STRMADDR  = channelcfg->all_reg.VEDU_VCPI_STRMADDR;
	}

	{
		pAllReg->VEDU_VCPI_SWPTRADDR = channelcfg->all_reg.VEDU_VCPI_SWPTRADDR;
	}

	{
		pAllReg->VEDU_VCPI_SRPTRADDR = pEncPara->vcpi_csst_srptraddr;
	}
	//�Ĵ�������洢��ַ
	{
		pAllReg->VEDU_VCPI_LLILD_ADDR = pEncPara->vcpi_llild_addr;
	}
	...
	{
		U_VEDU_VCPI_CROP_END  D32;
		D32.bits.vcpi_crop_xend = pEncPara->vcpi_crop_xend;
		D32.bits.vcpi_crop_yend = pEncPara->vcpi_crop_yend;
		pAllReg->VEDU_VCPI_CROP_END.u32   =   channelcfg->all_reg.VEDU_VCPI_CROP_END.u32;
	}

	{
		U_VEDU_VCPI_SCALE_PARA  D32;
		D32.bits.vcpi_xscale = pEncPara->vcpi_xscale;
		D32.bits.vcpi_yscale = pEncPara->vcpi_yscale;
		pAllReg->VEDU_VCPI_SCALE_PARA.u32   =   channelcfg->all_reg.VEDU_VCPI_SCALE_PARA.u32;
	}
#endif
	{
...
#if 0
	{
		...
		D32.bits.vcpi_intra32_low_power_en = DIST_PROTOCOL(vcpi_protocol, 1, 0);
...

	{
		...
		D32.bits.vcpi_intra16_low_power_en = DIST_PROTOCOL(vcpi_protocol, 1, 0);
	...
	{
		pAllReg->VEDU_VCPI_DBLK_INFO_ADDR = pEncPara->vcpi_dblk_info_addr;
	}
	...
	{
		pAllReg->VEDU_VCTRL_SEL_INTER_RDO_FACTOR_0.u32 = channelcfg->all_reg.VEDU_VCTRL_SEL_INTER_RDO_FACTOR_0.u32;
	}

	{
		pAllReg->VEDU_VCTRL_SEL_INTER_RDO_FACTOR_1.u32 = channelcfg->all_reg.VEDU_VCTRL_SEL_INTER_RDO_FACTOR_1.u32;
	}
	...
	{
		pAllReg->VEDU_VCTRL_SEL_INTER_RDO_FACTOR_2.u32 = channelcfg->all_reg.VEDU_VCTRL_SEL_INTER_RDO_FACTOR_2.u32;
	}

	{
		pAllReg->VEDU_VCTRL_SEL_LAYER_RDO_FACTOR.u32 = channelcfg->all_reg.VEDU_VCTRL_SEL_LAYER_RDO_FACTOR.u32;
	}
...
//////////////////
...

	{
		...
		//D32.bits.pme_intra_lowpow_en = DIST_PROTOCOL(vcpi_protocol, 0x1, 0);
...

	{
		...
		D32.bits.pme_cost_lamda0 = channelcfg->all_reg.VEDU_PME_NEW_COST.bits.pme_cost_lamda0;
		D32.bits.pme_cost_lamda1 = 0x2;
		//D32.bits.pme_cost_lamda2 = 0xF;
		D32.bits.pme_new_cost_en = DIST_PROTOCOL(vcpi_protocol, 0x0, 0x3);
		//D32.bits.pme_cost_lamda_en = 0;
		D32.bits.pme_mvp3median_en = 0;
		pAllReg->VEDU_PME_NEW_COST.u32   =   D32.u32;
	}
...

	{
		...
		D32.bits.qpg_row_target_bits = DIST_PROTOCOL(vcpi_protocol, 0xB956, 0x0);
...

	{
		...
		D32.bits.qpg_skin_max_qp = DIST_PROTOCOL(vcpi_protocol, 0x1E, 0x33);
		D32.bits.qpg_skin_qp_delta = DIST_PROTOCOL(vcpi_protocol, 0x2, 0x3);
...

	{
		...
		D32.bits.qpg_cu_qp_delta_thresh2 = DIST_PROTOCOL(vcpi_protocol, 1, 2);
		D32.bits.qpg_cu_qp_delta_thresh3 = DIST_PROTOCOL(vcpi_protocol, 1, 2);
...

	{
		...
		D32.bits.qpg_cu_qp_delta_thresh9 = DIST_PROTOCOL(vcpi_protocol, 0xA, 0x8);
		D32.bits.qpg_cu_qp_delta_thresh10 = DIST_PROTOCOL(vcpi_protocol, 0x14, 0x8);
		D32.bits.qpg_cu_qp_delta_thresh11 = DIST_PROTOCOL(vcpi_protocol, 0x14, 0xF);
...

	{
		...
		D32.bits.fme_pu64_lwp_flag = 0x1;
...
///////////////////
	{
		...
		D32.bits.mrg_force_zero_en = DIST_PROTOCOL(vcpi_protocol, 0x1, 0x0);
		D32.bits.mrg_force_y_zero_en = DIST_PROTOCOL(vcpi_protocol, 0x1, 0x0);
		D32.bits.mrg_force_u_zero_en = DIST_PROTOCOL(vcpi_protocol, 0x1, 0x0);
		D32.bits.mrg_force_v_zero_en = DIST_PROTOCOL(vcpi_protocol, 0x1, 0x0);
...
#if 0
	{
		pAllReg->VEDU_MRG_BIAS_COST0.u32   =   0;
	}
...
////////////////
	{
		pAllReg->VEDU_INTRA_CHNL4_ANG_0EN.u32 =  DIST_PROTOCOL(vcpi_protocol, (0), (0xffffffff | 0x4));
	...
	{
		pAllReg->VEDU_SEL_INTRA_ABS_OFFSET0.u32 = channelcfg->all_reg.VEDU_SEL_INTRA_ABS_OFFSET0.u32 ;
	}

	{
		pAllReg->VEDU_SEL_INTRA_ABS_OFFSET1.u32 = channelcfg->all_reg.VEDU_SEL_INTRA_ABS_OFFSET1.u32 ;
	}

	{
		pAllReg->VEDU_SEL_INTER_ABS_OFFSET0.u32 = channelcfg->all_reg.VEDU_SEL_INTER_ABS_OFFSET0.u32 ;
	}
	////////////////
...
#if 0	 //K3 no need suport PPFD function
	{
		pAllReg->VEDU_PPFD_ST_ADDR0 = pEncPara->ppfd_st_aadr0;
	}

	{
		pAllReg->VEDU_PPFD_ST_ADDR1  = pEncPara->ppfd_st_aadr1;
	}

	{
		pAllReg->VEDU_PPFD_ST_LEN0 = pEncPara->ppfd_st_len0;
	}

	{
		pAllReg->VEDU_PPFD_ST_LEN1 = pEncPara->ppfd_st_len1;
	}

	{
		U_VEDU_PPFD_ST_CFG  D32;
		D32.bits.ppfd_st_cmp_en = pEncPara->ppfd_st_cmp_en;
		D32.bits.ppfd_st_bypass_en = pEncPara->ppfd_st_bypass_en;
		pAllReg->VEDU_PPFD_ST_CFG   =   channelcfg->all_reg..u32;
	}

	{
		U_VEDU_ENV_CHN  D32;
		D32.bits.env_chn_curr_id = pEncPara->env_chn_curr_id;
		D32.bits.env_chn_goptype = pEncPara->env_chn_goptype;
		D32.bits.env_chn_bfrm_num = pEncPara->env_chn_bfrm_num;
		pAllReg->VEDU_ENV_CHN   =   channelcfg->all_reg..u32;
	}
#endif
	...
	HI_DBG_VENC("%s,ADDR--SMMU_MSTR_GLB_BYPASS=%x,xxx00=%x,VCPI_INTMASK=%x\n", __func__,(&(pAllReg->MMU_PRE_GLB_SCR)),pAllReg->MMU_PRE_GLB_SCR.bits.glb_scr,(&(pAllReg->VEDU_VCPI_INTMASK)));
