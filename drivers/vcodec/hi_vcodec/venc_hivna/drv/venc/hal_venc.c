...
HI_VOID VeduHal_CfgReg_IntraSet(VENC_REG_INFO_S *channelcfg)
{
    ...
    HI_INFO_VENC("**********************VeduHal_CfgReg_IntraSet\n");
...
HI_VOID VeduHal_CfgReg_QpgmapSet(VENC_REG_INFO_S *channelcfg  )
{
    ...
    HI_INFO_VENC("**********************VeduHal_CfgReg_QPGMAP\n");
    pAllReg = (S_HEVC_AVC_REGS_TYPE*)VeduIpCtx.pRegBase;
...
HI_VOID VeduHal_CfgReg_AddrSet(VENC_REG_INFO_S *channelcfg)
{
    ...
    HI_INFO_VENC("HAl ADDRSet,pEncPara_channel->VEDU_VCPI_SRC_YADDR=%x\n",channelcfg->all_reg.VEDU_VCPI_SRC_YADDR);
    HI_INFO_VENC("HAl ADDRSet,pEncPara_channel->VEDU_VCPI_SRC_CADDR=%x\n",channelcfg->all_reg.VEDU_VCPI_SRC_CADDR);
    HI_INFO_VENC("HAl ADDRSet,pEncPara_channel->VEDU_VCPI_SRC_VADDR=%x\n",channelcfg->all_reg.VEDU_VCPI_SRC_VADDR);
    HI_INFO_VENC("HAl ADDRSet,pEncPara_channel->vcpi_curld_c_stride=%x\n",channelcfg->all_reg.VEDU_VCPI_STRIDE.bits.vcpi_curld_c_stride);
    HI_INFO_VENC("HAl ADDRSet,pEncPara_channel->vcpi_curld_y_stride=%x\n",channelcfg->all_reg.VEDU_VCPI_STRIDE.bits.vcpi_curld_y_stride);
