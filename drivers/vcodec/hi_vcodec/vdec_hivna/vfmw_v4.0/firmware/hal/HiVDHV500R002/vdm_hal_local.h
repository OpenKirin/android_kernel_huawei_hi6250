...
#define    VREG_CRG_CLK_EN                     0xcc04//0xf804
#define    CRG_CLK_EN_DEFAULT_VALUE            0xffffffff
#define    VREG_CRG_CLK_SEL                    0xcc08//0xf808
...
typedef struct {
	USIGN src_head_ystaddr;
} VDMRPMSG_D8;  // D0 in Burst1 (VDH)

typedef struct {
	USIGN src_head_cstaddr;

} VDMRPMSG_D9;  // D1 in Burst1 (VDH)

typedef struct {
	USIGN dst_head_ystaddr;
} VDMRPMSG_D10;  // D2 in Burst1 (VDH)

typedef struct {
	USIGN dst_head_cstaddr;
} VDMRPMSG_D11;
