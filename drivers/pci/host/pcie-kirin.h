...
#define PCIE_PR_ERR(fmt, args ...)	do {	printk(KERN_ERR "[PCIE]%s:" fmt "\n", __FUNCTION__, ##args); } while (0)
#define PCIE_PR_INFO(fmt, args ...)	do {	printk(KERN_INFO "[PCIE]%s:" fmt "\n", __FUNCTION__, ##args); } while (0)
#define PCIE_PR_DEBUG(fmt, args ...)	do {	printk(KERN_DEBUG "[PCIE]%s:" fmt "\n", __FUNCTION__, ##args); } while (0)
