...
#define per_cpu_set(coreID, name, value)  OS_OTHER_PER_CPU_SET(coreID, name, value)
...
#define per_cpu_ptr(ptr,cpu) /*lint -save -e160*/({ (void)(cpu); ptr; })/*lint -restore */
...
#define per_cpu_set(coreID, name, value)  (name=value)
#endif
#endif
