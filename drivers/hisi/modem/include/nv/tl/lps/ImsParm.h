...
typedef struct{
    ...
    VOS_UINT8        ucKeepAliveFlag;
    VOS_UINT8        ucIpsecFlag;
    VOS_UINT8        ucReserved6;
    VOS_UINT8        ucReserved7;
...
}IMS_PARM_SIP_TIMER_STRU;



/*****************************************************************************
 * 11. emergency category
 NV_ID 
*****************************************************************************/
typedef struct{
    ...
    VOS_UINT8        aucUrn[65];
    VOS_UINT8        aucRsv[2];
}IMS_EMERGENCY_CATEGORY_URN_STRU;

typedef struct
{
    IMS_EMERGENCY_CATEGORY_URN_STRU astEmerCatUrn[6];
}IMS_NV_EMERGENCY_URN_STRU;
