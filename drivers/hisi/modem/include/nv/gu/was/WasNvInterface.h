 ...
 ******************************************************************************
  ...
  1.日    期   : 2017年1月17日
    作    者   : s00184266
    修改原因   : dts2017011702266, 增加DESCRIPTION字段描述
...
#define WAS_NV_ACALLBAR_DEFAULT_TIME                   (1280)                   /* AC ALL BAR 默认惩罚时间，单位是s*/
#define WAS_NV_ACALLBAR_MIN_TIME                       (10)                     /* AC ALL BAR 最小惩罚时间，单位是s*/
#define WAS_NV_ACALLBAR_MAX_TIME                       (1280)                   /* AC ALL BAR 最大惩罚时间，单位是s*/
...
/*****************************************************************************
 ...
 DESCRIPTION:历史PLMN和对应的频点信息
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              ulPlmnCnt;                          /* 保存在NV中的PLMN个数，Range:[0,32] */
    WAS_NVIM_HISTORY_FREQ_LIST_STRU         astNvPlmnFreqPair[WAS_HISTORY_PLMN_MAX_NUM];/* 保存的PLMN及其对应的频点信息 */
...
/*****************************************************************************
 ...
 DESCRIPTION:存放保存的历史PLMN和对应的频点信息
*****************************************************************************/
typedef struct
{
    VOS_UINT8                               ucPlmnNum;                          /* 定制的PLMN个数，最大为20个 */
    VOS_UINT8                               ucReportCellNum;                    /* 运营商频点搜索时只是DSP上报的小区个数最小值，Range:[1,32] */
    VOS_UINT8                               ucSearchOperatorBandFlg;            /* 是否要搜历史频点和运营商频点所在的band */
    VOS_UINT8                               aucResvered2;
    WAS_NVIM_OPERATOR_FREQ_INFO_STRU        ausPlmnFreqList[WAS_OPERATOR_PLMN_MAX_NUM]; /* 定制的PLMN ID以及频点信息 */
...
/*****************************************************************************
 ...
 DESCRIPTION:存放背景搜Threshold参数信息
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION:存放Broken Cell的参数设置信息
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: Errorlog弱信号的门限 
*****************************************************************************/
typedef struct
{
    VOS_INT16                               sRscpThreshold;                     /* WCDMA ErrorLog特性弱信号的RSCP门限值，Range:[-130,-25] */
    VOS_INT16                               sECN0Threshold;                     /* WCDMA ErrorLog特性弱信号的ECN0门限值，Range:[-25,0] */
...
/*****************************************************************************
 ...
 DESCRIPTION: 小区信号强度上报定时器长度和RSCP变化的门限配置项
*****************************************************************************/
typedef struct
{
    VOS_UINT8                               ucPeriodTimerLen;                   /* 定时器长度，Range:[0,255],单位:秒 */
    VOS_UINT8                               ucRscpThreshold;                    /* RSCP的门限值，Range:[0,255],单位:db */
    VOS_UINT8                               ucEcn0Threshold;                    /* ECN0的门限值，Range:[0,255],单位:db */
...
/*****************************************************************************
 ...
 DESCRIPTION: W下其他备选能力配置项
*****************************************************************************/
typedef struct
{
    /* Was_Customized_Para */
    VOS_UINT8                               ucSbmMaskSupportType;               /* 软银定制需求:在非国际漫游时是否屏蔽2.1GHz频段，0x0:不屏蔽,0x1:屏蔽 */
...
typedef struct
{
    ...
    VOS_UINT16                              usWRscpThresh;                      /* W服务小区RSCP门限，大于门限才能使用重选OFFSET，取绝对值,Range:[0,928]*/
    VOS_UINT16                              usWEcnoThresh;                      /* W服务小区ECNO门限，大于门限才能使用重选OFFSET，取绝对值,Range:[0,160]*/
    VOS_UINT16                              usEutranCellRsrpOffset;             /* EUTRAN小区RSRP OFFSET,Range:[0,1040] */
    VOS_UINT16                              usEutranCellRsrqOffset;             /* EUTRAN小区RSRQ OFFSET,Range:[0,160] */
...
/*****************************************************************************
 ...
 DESCRIPTION: 全频段搜网过程中使用的RSSI门限设置
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 控制W下PLMN LIST搜索时全频段搜网门限
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 保存用户设置的指定频点值。此频点优先级仅次于NV项中存储的先验频点
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 是否支持PDCP无损迁移
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              usNvPdcpLossLessSwitch;    /* PDCP 无损迁移开关,Range:[0,1]*/
    VOS_UINT8                               aucReserve[2];
...
/*****************************************************************************
 ...
 DESCRIPTION: 不同速率对应的mapweight的值
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 日本的EMOIBLE网络中的plmn信息，该plmn LTE需要用到
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: Errorlog:CS 语音切换的时长
 修改历史  :
 1.日    期    : 2014年9月2日
   作    者    : 00134354
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 DESCRIPTION: 国家定制全频带搜索的band数据结构
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: CSFB时根据国家定制全频带搜索的band
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: W2L重选相关定制参数，用于解决3G、4G制式之间频繁切换的问题
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 软银定制动态适配DCDPA,此NV依赖与3001
 修改历史  :
 1.日    期    : 2015年5月4日
   作    者    : x81004927 
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 DESCRIPTION: 软银双imsi开关和MCC信息,LTE预制的band信息
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: D态下测量评估时，小区偏置参数控制配置
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: WAS 云通信控制NV,非NV结构，从NV中读取后保存nv的结构
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 网络没有配置T314时使用NV定制默认参数
 修改历史  :
  1.日  期   : 2015年12月29日
    作  者   : j00169676
    修改内容 : 新生成结构
...
/*****************************************************************************
 ...
 DESCRIPTION: S准则不满足且不满足测量启动条件，评估启动邻区重选的门限，
              例:RSCP低于-115或ecn0低于-18才允许重选
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 不存在信令连接时启动保护定时器控制配置
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 存放ERACH Broken Cell的参数设置    
*****************************************************************************/
...
/*****************************************************************************
 ...
 DESCRIPTION: 存放ERACH 系统消息变更CR的参数设置 
*****************************************************************************/
...
/*****************************************************************************
 ...
 DESCRIPTION: 用于控制CHR主动上报的时间间隔参数控制
1.日  期   : 2017年1月10日
  作  者   : w00402148
  修改内容 : 新增随机接入失败上报时间间隔的NV控制
*****************************************************************************/
typedef struct
{
    VOS_UINT8                        ucRptTimeIntervalForOtaMsgCheckFail;       /* 用于空口检查失败事件的上报间隔，单位为min */
    VOS_UINT8                        ucRptRaFailMinTimeInterval;                /* 用于控制随机接入失败的最小上报间隔，单位为min */
    VOS_UINT8                        ucRptRrcAccessLongMinTimeInterval;         /* 用于控制随机接入时间过长的最小上报间隔，单位为min  */
    VOS_UINT8                        ucRptRadioResCheckMinTimeInterval;         /* 用于控制资源核查事件的最小上报间隔，单位为min  */
    VOS_UINT8                        ucRptStateLastTimeMinTimeInterval;         /* 用于控制各协议态占比的最小上报间隔，单位为hour  */
    VOS_UINT8                        ucRptStateLastTimForPoweroff;              /* 用于控制各协议态占比的最小上报间隔，单位为hour(关机场景)  */
    VOS_UINT8                        ucRptW2WReselSlowMinTimeInterval;          /* 用于控制W2W重选慢的最小上报间隔，单位为hour  */
    VOS_UINT8                        ucRptWoosSectionChrRptInterval;            /* 用于控制WOOS阶段上报时间间隔，单位min  */
...
/*****************************************************************************
 结构名    : WAS_NVIM_ERRLOG_THRESHOLD_CONFIG_STRU
 结构说明  : 用于控制CHR门限参数的NV配置
 DESCRIPTION: 用于控制CHR门限参数的NV配置
1.日  期   : 2017年1月10日
  作  者   : w00402148
  修改内容 : 新生成结构
*****************************************************************************/
typedef struct
{
    VOS_INT16                        sRptRaFailRscpThreshold;                   /* 随机接入失败RSCP上报门限，超过该门限才上报  */
    VOS_INT16                        sRptRaFailEcNoThreshold;                   /* 随机接入失败Ec/No上报门限，超过该门限才上报  */

    VOS_UINT8                        ucRptRrcAccessLongTimeThreshold;           /* 随机接入时间过长的判定门限，单位sec  */
    VOS_UINT8                        ucRptW2WReselSlowTimeThreshold;            /* W2W重选时长判定门限，单位sec  */
    VOS_UINT8                        ucReserve3;                                /* 保留位  */
    VOS_UINT8                        ucReserve4;                                /* 保留位  */

    VOS_INT16                        sReserve1;                                /* 保留位  */
    VOS_INT16                        sReserve2;                                /* 保留位  */
    VOS_INT16                        sReserve3;                                /* 保留位  */
    VOS_INT16                        sReserve4;                                /* 保留位  */
    VOS_INT16                        sReserve5;                                /* 保留位  */
    VOS_INT16                        sReserve6;                                /* 保留位  */
    VOS_INT16                        sReserve7;                                /* 保留位  */
    VOS_INT16                        sReserve8;                                /* 保留位  */
    VOS_INT16                        sReserve9;                                /* 保留位  */
    VOS_INT16                        sReserve10;                               /* 保留位  */
...
typedef struct
{
    PS_BOOL_ENUM_UINT8                      enRaLongFlg;                        /* 随机接入时间过长主动上报NV开关 */
    PS_BOOL_ENUM_UINT8                      enResCheckFlg;                      /* 资源核查主动上报NV开关 */
    PS_BOOL_ENUM_UINT8                      enStateLastTimeFlg;                 /* 协议态持续时间主动上报NV开关 */
    PS_BOOL_ENUM_UINT8                      enW2WReselSlowFlg;                  /* W2W重选慢事件主动上报NV开关 */
    PS_BOOL_ENUM_UINT8                      enWoosSectionChrFlag;               /* WOOS阶段事件主动上报NV开关 */
    VOS_UINT8                               ucReserve1;                         /* 保留位  */
    VOS_UINT8                               ucReserve2;                         /* 保留位  */
    VOS_UINT8                               ucReserve3;                         /* 保留位  */
    VOS_UINT8                               ucReserve4;                         /* 保留位  */
    ...
    VOS_UINT8                               ucReserve10;                        /* 保留位  */
    VOS_UINT8                               ucReserve11;                        /* 保留位  */
    VOS_UINT8                               ucReserve12;                        /* 保留位  */
    VOS_UINT8                               ucReserve13;                        /* 保留位  */
    VOS_UINT8                               ucReserve14;                        /* 保留位  */
    VOS_UINT8                               ucReserve15;                        /* 保留位  */
...
/*****************************************************************************
 ...
 DESCRIPTION: 重定向CSFB或者搜网CSFB流程S准则定制设置
*****************************************************************************/
...
/*****************************************************************************
 ...
 DESCRIPTION: 获取Geo搜网是否需要解SIB1的控制开关
 修改历史  :
  1.日  期   : 2016年9月7日
    作  者   : h00377722
    修改内容 : 新生成结构
...
/*****************************************************************************
 ...
 DESCRIPTION: W2L重选挂起nas失败，W2L重选惩罚的控制开关
*****************************************************************************/
...
/*****************************************************************************
 ...
 DESCRIPTION: WAS Normal和Info级别打印的使能开关
 修改历史  :
  1.日  期   : 2016年10月25日
    作  者   : j00169676
    修改内容 : 新生成结构
...
/*****************************************************************************
 ...
 DESCRIPTION: 存储在NVIM中的W切换到LTE功能控制开关
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 ...
 DESCRIPTION: 存储在NVIM中的W连接态LTE测量功能控制开关
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 ...
 DESCRIPTION: 存储在NVIM中的FDPCH/EFDPCH使能控制开关
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 ...
 DESCRIPTION: 存储在NVIM中的EFACH相关配置  
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 结 构 名  : NVIM_GUAS_ACBAR_CFG_INFO_STRU
 结构说明  : 存储在NVIM中的各接入技术的AC BAR相关配置 
 DESCRIPTION: 存储在NVIM中的各接入技术的AC BAR相关配置 
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8                      enSuppAcAllBarFlg;                  /* 支持AC ALL BAR的特殊处理 */
    VOS_UINT8                               ucReserve1;    
    VOS_UINT8                               ucReserve2;  
    VOS_UINT8                               ucReserve3;  
    VOS_UINT16                              usAcAllBartime;                     /* AC ALL BAR惩罚定时器时长,单位:秒 */    
    VOS_UINT16                              usReserve1;                         /* 保留位 */
    VOS_UINT16                              usReserve2;                         /* 保留位 */
    VOS_UINT16                              usReserve3;                         /* 保留位 */     
...
/*****************************************************************************
 结 构 名  : NVIM_GUAS_AC_BAR_CFG_STRU
 结构说明  : 存储在NVIM中的AC BAR相关配置 
 DESCRIPTION: 存储在NVIM中的AC BAR相关配置 
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
typedef struct
{
    NVIM_GUAS_AC_BAR_CFG_INFO_STRU          stGsmAcBarCfg;                       /* GSM的AC BAR配置信息 */
    NVIM_GUAS_AC_BAR_CFG_INFO_STRU          stWcdmaAcBarCfg;                     /* WCDMA的AC BAR配置信息 */
}NVIM_GUAS_AC_BAR_CFG_STRU;

/* Added by h00377722 for 系统消息优化, 2016-11-15, begin */
/*****************************************************************************
 枚 举 名  : WAS_SIB_POS_NOTIFY_ENUM_UINT8
 枚举说明  : 支持精确解的流程场景
 DESCRIPTION: 支持精确解的流程场景
 修改历史  :
  1.日  期   : 2016年10月10日
    作  者   : w00380530
    修改内容 : 新生成结构
...
enum WAS_SIB_POS_NOTIFY_ENUM
{
    ...
    WAS_SIB_POS_NOTIFY_RESEL                = 0x00000001,   /* bit0: 重选 */
    WAS_SIB_POS_NOTIFY_CELL_SELECT          = 0x00000002,   /* bit1: 除重选之外的搜网驻留流程 */
    WAS_SIB_POS_NOTIFY_SIB_UPDATE           = 0x00000004,   /* bit2: 系统消息更新、6小时更新 */
    WAS_SIB_POS_NOTIFY_BG_SEARCH            = 0x00000008,   /* bit3: 主从模下的背景搜、inter list搜、inter list pre band搜 */
    WAS_SIB_POS_NOTIFY_ANR                  = 0x00000010,   /* bit4: anr */
    WAS_SIB_POS_NOTIFY_RCV_SIB7             = 0x00000020,   /* bit5: 周期性解SIB7 */
    WAS_SIB_POS_NOTIFY_DCH_SYSINFO          = 0x00000040,   /* bit6: D下解系统消息 */
    WAS_SIB_POS_NOTIFY_GEO                  = 0x00000080,   /* bit7: GEO搜网 */
    WAS_SIB_POS_NOTIFY_USER_LIST            = 0x00000100,   /* bit8: user list搜网 */  
...
/*****************************************************************************
 ...
 DESCRIPTION: CSFB时网络不支持DMCR时不需要解SIB11\SIB19等定制NV
 修改历史  :
  1.日  期   : 2016年12月20日
    作  者   : j00169676
    修改内容 : 新生成结构
...
/*****************************************************************************
 结构名     : WAS_NVIM_SYS_INFO_CHG_FAIL_OPTIMIZE_CFG_STRU
 DESCRIPTION: 系统消息变更失败优化控制NV
 修改历史   :
 1.日    期    : 2016年12月13日
   作    者    : z00184470
   修改内容    : 新建结构体
...
typedef struct
{
    PS_BOOL_ENUM_UINT8                              enSysInfoChgFailOptmizeFlg; /* 系统消息变更失败优化使能总开关 */
    PS_BOOL_ENUM_UINT8                              enCsMtCallCustFlg;          /* 系统消息变更失败优化使能总开关打开的情况下，指示是否需要对被叫业务特殊定制的标记 */
    VOS_UINT8                                       ucReserve1;                 /* 保留位 */
    VOS_UINT8                                       ucReserve2;                 /* 保留位 */
}WAS_NVIM_SYS_INFO_CHG_FAIL_OPTIMIZE_CFG_STRU;

/*****************************************************************************
 结 构 名  : WAS_NV_SIB_PRECISE_RCV_CFG_STRU
 结构说明  : 精确解广播配置定制NV
 DESCRIPTION: 精确解广播配置定制NV
 修改历史  :
  1.日  期   : 2016年11月15日
    作  者   : h00377722
    修改内容 : 新生成结构
...
typedef struct
{
    VOS_UINT32              ulSibPreciseRcvCfgEnableBitmap;                     /* 精确解广播配置使能bit位 */
    VOS_UINT16              usSibPreciseRcvCfgSbRepMin;                         /* 收到MIB判断Sb1、Sb2周期是否小于该值，小于则在收到SB消息时才发送精确解 */
    VOS_UINT8               ucReserved1;                                        /* 保留位 */
    VOS_UINT8               ucReserved2;                                        /* 保留位 */
...
/*****************************************************************************
 结 构 名  :  WAS_NVIM_INITIAL_SIR_TARGET_CTRL_STRU
 结构说明  :  用于配置InitailSirTarget的Deta值
 DESCRIPTION: 用于配置InitailSirTarget的Deta值
 修改历史  :
  1.日  期   : 2016年2月3日
    作  者   : j00169676
    修改内容 : 新生成结构
...
typedef struct
{
    VOS_UINT8                        ucInitailSirTargetDeta1;                   /* ucPwrOffsetPilotPdpdch为[0-6)时的Deta值，默认为0 */
    VOS_UINT8                        ucInitailSirTargetDeta2;                   /* ucPwrOffsetPilotPdpdch为[6-12)时的Deta值，默认为15 */
    VOS_UINT8                        ucInitailSirTargetDeta3;                   /* ucPwrOffsetPilotPdpdch为[12-18)时的Deta值，默认为30 */
    VOS_UINT8                        ucInitailSirTargetDeta4;                   /* ucPwrOffsetPilotPdpdch为[18-24]时的Deta值，默认为45 */
}WAS_NVIM_INITIAL_SIR_TARGET_CTRL_STRU;

/*****************************************************************************
 结 构 名  : WAS_NVIM_INTERRAT_RESEL_OPTIMIZE_CTRL_STRU
 结构说明  : 异系统重选相关优化定制开关
...
typedef struct
{
    PS_BOOL_ENUM_UINT8               enNotAllowedInterRatReselCallProc;         /* 呼叫发起过程中是否允许异系统重选使能开关 */
    VOS_UINT8                        ucRsv1;
    VOS_UINT8                        ucRsv2;
    VOS_UINT8                        ucRsv3;
    VOS_UINT8                        ucRsv4;
...
/*****************************************************************************
 ...
 DESCRIPTION: was和gas是否要申请搜网资源控制NV
 修改历史  :
  1.日    期   : 2017年01月05日
    作    者   : p00179010
    修改原因   : 新生成结构
...
/*****************************************************************************
 结 构 名  : NVIM_WAS_OOS_CELL_SEARCH_OPTIMIZE_CFG_STRU
 结构说明  : was搜网出服务区需要搜网的相关参数
 DESCRIPTION: was搜网出服务区需要搜网的相关参数NV
 修改历史  :
  1.日    期   : 2017年01月05日
    作    者   : p00179010
    修改原因   : 新生成结构
...
typedef struct
{
    VOS_UINT8                               ucOosHistorySearchCount;        /* WAS连接态下出服务区搜历史频点的轮数 */
    PS_BOOL_ENUM_UINT8                      enOosHistorySearchFlg;          /* WAS连接态下出服务区搜历史频点的开关，异系统完全由这个开关控制，本系统需要与nv为3037的出服务区标记求交集 */        
    PS_BOOL_ENUM_UINT8                      enOosPrefbandSearchFlg;         /* WAS连接态下出服务区搜prefband的开关，异系统完全由这个开关控制，本系统需要与nv为3037的出服务区标记求交集 */    
    PS_BOOL_ENUM_UINT8                      enOosAllbandSearchFlg;          /* WAS连接态下出服务区搜allband的开关，异系统完全由这个开关控制，本系统需要与nv为3037的出服务区标记求交集 */  
    VOS_UINT8                               ucReserve1;
    VOS_UINT8                               ucReserve2;
    VOS_UINT8                               ucReserve3;
    VOS_UINT8                               ucReserve4;
...
/*****************************************************************************
 结 构 名  : WAS_NVIM_EDRX_CFG_STRU
 结构说明  : EDRX控制开关
 DESCRIPTION :EDRX NV控制开关
 修改历史  :
  1.日  期   : 2016年11月22日
    作  者   : z00370395
    修改内容 : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8      enEdrxSupport;                                      /* 定制Edrx的使能开关 */
    VOS_UINT8               ucReserved1;                                        /* 保留位 */
    VOS_UINT8               ucReserved2;                                        /* 保留位 */
    VOS_UINT8               ucReserved3;                                        /* 保留位 */
...
/*****************************************************************************
 结 构 名  : NVIM_GUAS_CSFB_REDIRECT_OPTIMIZE_CFG_STRU
 结构说明  : GUAS CSFB下重定向优化配置
 DESCRIPTION: GUAS CSFB下重定向优化配置
 修改历史  :
  1.日    期   : 2017年03月13日
    作    者   : z00370395
    修改原因   : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8                  enGAlwaysRedirToLRcvRelWithEarfcn;      /* GAS收到网络Release消息中带EARFCN,是否无条件重定向 */
    PS_BOOL_ENUM_UINT8                  enWAlwaysRedirToLRcvRelWithEarfcn;      /* WAS收到网络Release消息中带EARFCN,是否无条件重定向 */    
    VOS_UINT8                           ucReserve1;         
    VOS_UINT8                           ucReserve2;         
    VOS_UINT8                           ucReserve3;
    VOS_UINT8                           ucReserve4;
...
/*****************************************************************************
 结 构 名  : WAS_NVIM_MEAS_EVT_EVAL_CUSTOMIZE_CFG_STRU
 结构说明  : 测量事件评估定制参数
 DESCRIPTION: 测量事件评估定制参数
 修改历史  :
  1.日  期   : 2017年03月11日
    作  者   : z00184470
    修改内容 : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8              enMeasEvtEvalCustCtrlFlg;                   /* 测量事件评估定制使能总开关  */
    VOS_UINT8                       ucReserve1;                                 /* 保留位 */
    VOS_UINT16                      usEvt1bTimeToTrigCustLen;                   /* 1b事件评估定时器定制时长，单位为ms */
    VOS_UINT16                      usReserve2;                                 /* 保留位 */
    VOS_UINT16                      usReserve3;                                 /* 保留位 */
    VOS_UINT16                      usReserve4;                                 /* 保留位 */
    VOS_UINT16                      usReserve5;                                 /* 保留位 */
    VOS_UINT16                      usReserve6;                                 /* 保留位 */
    VOS_UINT16                      usReserve7;                                 /* 保留位 */
    VOS_INT16                       sReserve8;                                  /* 保留位 */
    VOS_INT16                       sReserve9;                                  /* 保留位 */
...
/*****************************************************************************
 结 构 名  : WAS_NV_INTER_FREQ_HANDOVER_CUST_CFG_STRU
 结构说明  : 抑制异频切换频繁失败相关定制参数
 DESCRIPTION: 抑制异频切换频繁失败相关定制参数
 修改历史  :
  1.日  期   : 2017年5月13日
    作  者   : z00184470
    修改内容 : 新生成结构
