...
typedef struct
{
    VOS_UINT32                          uwDpdAlgSel             :4;             /* DPD算法选择0:数学特性计算DPD,1:物理特性计算DPD */
    VOS_UINT32                          uwProtectIndex          :7;             /* LUT表保护索引值,默认值:10 */
    VOS_UINT32                          uwDpdSmoothLen          :5;             /* 平滑长度,默认值:9 */
    VOS_UINT32                          uwPaGainCorrectFactor   :16;            /* LUT归一化相关值,默认值:1036 */
    ...
    VOS_UINT32                          uwStepDataLen           :12;            /* 一阶的采数长度，必须为一个单音周期点数的整数倍
                                                                                   默认值:512 */
    VOS_UINT32                          uwRedundantStepNum      :4;             /* 阶梯波形冗余阶数，用于找突变点,默认值:2 */
    VOS_UINT32                          uwReserved0             :12;            /* 保留 */
...
typedef struct
{
    ...
    VOS_UINT16                          uhwReserve1;                            /* 用于dallas C60限制PA VCC电压*/
...
typedef struct
{
    VOS_UINT32                                  uwAccessMasEnable:2;            /* TAS主控下access态 MAS功能使能:1,代表使能;0,代表不使能. 默认为0 */
    VOS_UINT32                                  uwIdleMasEnable:2;              /* TAS主控下idle态 MAS功能使能:1,代表使能;0,代表不使能. 默认为0 */
    VOS_UINT32                                  uwSearchingMasEnable:2;         /* TAS主控下searching态 MAS功能使能:1,代表使能;0,代表不使能. 默认为0 */
...
typedef struct
{
    ...
    VOS_UINT16                              uhwSearchingCtrl[3];                /* Searching态控制标志. */
