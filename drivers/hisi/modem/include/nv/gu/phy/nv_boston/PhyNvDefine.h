...
#define UCOM_NV_G_TX_PWR_MIN_VALID_NUM      ( 2 )                               /* 插值算法必须大于等于2个点 */
...
#define UCOM_NV_CROSS_LNA_MEM_INDEX_MAX_NUM        ( 512 )                      /* NV_CROSS_LNA_MEM_INDEX中存放的最大数目 */
#define UCOM_NV_CROSS_MIPI_MEM_INDEX_MAX_NUM       ( 512 )                      /* NV_CROSS_MIPI_MEM_INDEX中存放的最大数目 */
#define UCOM_NV_CROSS_GPIO_MEM_INDEX_MAX_NUM       ( 512 )                      /* NV_CROSS_GPIO_MEM_INDEX中存放的最大数目 */
...
#define UCOM_NV_PA_SWITCH_MAX_NUM           ( 3 )                               /* PA档位切换个数 */
...
#define UCOM_NV_W_TX_CFR_COMP_NUM                   ( 41 )
...
/* BBP接口提供4张DPD表，切换门限为5个，每张表深度为128,
   但目前只用到一张表，这节省空间，暂只定义两张表，后续有需求再新增NV */
#define UCOM_NV_DPD_LUT_MAX_NUM                     ( 2 )
#define UCOM_NV_DPD_LUT_THERSHOLD_MAX_NUM           ( 5 )
#define UCOM_NV_DPD_LUT_MAX_LEN                     ( 128 )

/* ET  LUT多项式系数量化 */
#define UCOM_NV_ET_LUT_POLY_COFF_A3_BIT             ( 33 )
#define UCOM_NV_ET_LUT_POLY_COFF_A2_BIT             ( 21 )
#define UCOM_NV_ET_LUT_POLY_COFF_A1_BIT             ( 21 )
#define UCOM_NV_ET_LUT_POLY_COFF_A0_BIT             ( 1 )
#define UCOM_NV_ET_LUT_VOLT_V2MV                    ( 1000 )                     /* PAVCC(V)的量化成mv */
#define UCOM_NV_ET_LUT_VOLT_TO_DAC_OFFSET           ( 7372800 )                  /* 2.4 * (3/8) * 8192 * 1000 */
#define UCOM_NV_ET_LUT_VOLT_TO_DAC_GAIN             ( 3072 )                     /* 3/8 * 8192 */
#define UCOM_NV_ET_LUT_MAX_DAC                      ( 8191 )
#define UCOM_NV_ET_LUT_MIN_DAC                      ( -8192 )



/* 单张ET LUT 长度 */
#define UCOM_NV_ET_LUT_MAX_LEN                      ( 256 )
#define UCOM_NV_ET_LUT_DAC_MAX_NUM                  ( UCOM_NV_ET_LUT_MAX_LEN )
#define UCOM_NV_ET_LUT_POWER_MAX_NUM                ( UCOM_NV_ET_LUT_MAX_LEN )
/* DPD模式 */
...
/* W下解调同失步判决PO3PO2差值数目 */
#define UCOM_NV_W_SYNC_QIN_QOUT_THRES_NUM           ( 5 )
...
/* GU MIPI回读列表个数 */
#define UCOM_NV_RDBACK_MIPI_NUM                     ( 16 )

/* GU MIPI回读Fix最大个数 */
#define UCOM_NV_RDBACK_FIX_MIPI_NUM                 ( 8 )

/* 总共的MIPI回读列表最大个数 */
#define UCOM_NV_RDBACK_MIPI_MAX_NUM                 ( UCOM_NV_RDBACK_MIPI_NUM + UCOM_NV_RDBACK_FIX_MIPI_NUM )
/*****************************************************************************
  3 Massage Declare
*****************************************************************************/
...
/*****************************************************************************
 枚举名    :UCOM_NV_G_APT_ENABLE_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  :GSM APT方式
*****************************************************************************/
enum UCOM_NV_G_APT_ENABLE_TYPE_ENUM
{
    UCOM_NV_G_APT_DISABLE                                   = 0,                /* 不使用Apt*/
    UCOM_NV_G_APT_ENABLE_MIPI                                  ,                /* 表示Apt使用Mipi */
    UCOM_NV_G_APT_ENABLE_GPIO                                  ,                /* 表示Apt使用GPIO */
    UCOM_NV_G_APT_ENABLE_BUTT
};
typedef VOS_UINT16 UCOM_NV_G_APT_ENABLE_ENUM_UINT16;

/*****************************************************************************
 枚举名    :UCOM_NV_W_PA_TRANS_OFFSET_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  :NV PA档位相关值转换过程中的偏移,档位值偏移为0,档位切换值偏移为1
*****************************************************************************/
enum UCOM_NV_W_PA_TRANS_OFFSET_ENUM
{
    UCOM_NV_W_PA_TRANS_OFFSET_GAIN                          = 0,                /* PA档位相关值 */
    UCOM_NV_W_PA_TRANS_OFFSET_SWITCH                        = 1,                /* PA档位切换相关值 */
    UCOM_NV_W_PA_TRANS_OFFSET_BUTT
};
typedef VOS_UINT16 UCOM_NV_W_PA_TRANS_OFFSET_ENUM_UINT16;
...
typedef struct
{
    ...
    VOS_UINT16                          uhwTempFilterCoff;                      /* 温度滤波系数 */
    ...
    VOS_INT16                           shwMinTempThr;                          /* 非极端最小温度门限 */
    VOS_INT16                           shwMaxTempThr;                          /* 非极端最大温度门限 */
...
typedef struct
{
    ...
    VOS_INT32                   swTemp;                                         /* 温度，单位0.1度 */
    VOS_INT32                   swPpm;                                          /* 相对频偏，定点化2^30/10^6 */
...
typedef struct
{
    VOS_INT32                   swTime;                                         /* 年月，比如2016.4表示值为1604,小于1604表示该样本无效 */
    VOS_INT32                   swPpm;                                          /* 相对频偏，定点化2^30/10^6 */
...
typedef struct
{
    VOS_INT32                   shwMinTemp;                                     /* 迭代1的变量名称暂时不修改，由迭代2同一规划修改 */
    VOS_INT32                   shwMaxTemp;                                     /* 迭代1的变量名称暂时不修改，由迭代2同一规划修改 */
...
typedef struct
{
    VOS_UINT16                         uhwMipiTunerEnable;                      /* TUNER_EN寄存器配置值 */
    VOS_UINT16                         uhwCrossMipiReqEnable;                   /* CROSS_MIPI_EN寄存器使能:
                                                                                   [0]:M0的MIPI指令模块12bit输入线控生效使能。
                                                                                   [1]:M1的MIPI指令模块8bit输入线控生效使能 */
    VOS_UINT16                         uhwCrossGpioReqEnable;                   /* CROSS_GPIO_EN寄存器使能:
                                                                                   [0]:M0的GPIO指令模块12bit输入线控生效使能。
                                                                                   [1]:M1的GPIO指令模块8bit输入线控生效使能 */
    VOS_UINT16                         uhwCrossLnaReqEnable;                    /* CROSS_LNA_EN寄存器使能:[0:11]LNA M0-M11模块输入线控生效使能。 */
    VOS_UINT32                         uwGpioMask;                              /* TUNER GPIO屏蔽:
                                                                                   [0:11]:屏蔽M0[11:0]
                                                                                   [12:19]:屏蔽M1[7:0]的信号 */
    VOS_UINT32                         uwTunerMipiMask;                         /* TUNER MIPI屏蔽:bit0:mipi.bit1:lna */
    VOS_UINT32                         uwTunerInputSel0;                        /* [0:1]tuner输出线控0选择:
                                                                                        0:内部线控，
                                                                                        1：外部IO输入，
                                                                                        2:内部线控和外部IO相或，
                                                                                        3：内部线控和外部IO相与）
                                                                                   ...
                                                                                   [30:31]tuner输出线控15选择
                                                                                                                */
    VOS_UINT32                         uwTunerInputSel1;                        /* [0:1]tuner输出线控16选择:
                                                                                        0:内部线控，
                                                                                        1：外部IO输入，
                                                                                        2:内部线控和外部IO相或，
                                                                                        3：内部线控和外部IO相与）
                                                                                   ...
                                                                                   [6:7]tuner输出线控19选择
                                                                                                                */
    VOS_UINT32                         uwGpioIoSel;                             /* 31bit线控输入输出选择(按照bit生效),0:输出,1:输入 */
    VOS_UINT32                         uwRsv0;                                  /* 预留 */
    VOS_UINT32                         uwRsv1;                                  /* 预留 */
    VOS_UINT32                         uwRsv2;                                  /* 预留 */
    VOS_UINT32                         uwRsv3;                                  /* 预留 */
...
/*****************************************************************************
 结构名    : UCOM_NV_CROSS_GPIO_MEM_INDEX_STRU
 协议表格  :
 结构说明  : 用于存储gpio指令
*****************************************************************************/
typedef struct
{
    VOS_UINT32                         auwGpioBuffer[UCOM_NV_CROSS_GPIO_MEM_INDEX_MAX_NUM];
}UCOM_NV_CROSS_GPIO_MEM_INDEX_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CROSS_LNA_MEM_INDEX_STRU
 协议表格  :
 结构说明  : 用于存储lna指令
*****************************************************************************/
typedef struct
{
    VOS_UINT32                         auwLnaBuffer[UCOM_NV_CROSS_LNA_MEM_INDEX_MAX_NUM];
}UCOM_NV_CROSS_LNA_MEM_INDEX_STRU;
...
typedef struct
{
    VOS_INT32                           shwInitFrequency;                       /* 普通晶体的初始频偏 迭代1的变量名称暂时不修改，由迭代2同一规划修改*/
    VOS_INT32                           shwInitTemperature;                     /* 普通晶体的初始温度 迭代1的变量名称暂时不修改，由迭代2同一规划修改*/
...
/*****************************************************************************
 结构名    : UCOM_NV_DCXO_SOFT_VERSION_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 迭代1的值均为1，迭代2的值均为2.在迭代2的时候，如果检测到board version
             的值为1，则进行量纲升级。
*****************************************************************************/
typedef struct
{
    VOS_UINT32                           uwSoftVersion;                         /* 软件版本 */
}UCOM_NV_DCXO_SOFT_VERSION_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_DCXO_BOARD_VERSION_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :备份恢复NV,迭代1新老单板默认值为1;迭代2老单板值为1,新单板值为2,
            升级结束后新老单板值均为2.
*****************************************************************************/
typedef struct
{
    VOS_UINT32                           uwBoardVersion;                        /* 老单板值为1，新单板值为2 */
}UCOM_NV_DCXO_BOARD_VERSION_STRU;
...
typedef struct
{
    VOS_UINT16                          uhwPaPrechgVoltHG;                      /*Range:[0,1023]*//* Rfic High Gain校准后的预充电压 */
    VOS_UINT16                          uhwPaPrechgVoltLG;                      /*Range:[0,1023]*//* Rfic Low Gain校准后的预充电压 */
...
/*****************************************************************************
 结构名    : UCOM_NV_EDGE_TX_GAIN_FREQ_COMP_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : Edge校准发射功率的补偿值
*****************************************************************************/
...
typedef struct
{
    UCOM_NV_G_APT_ENABLE_ENUM_UINT16     enGsmAptEnable;                        /* 2G APT使能标志 */
...
typedef struct
{
    VOS_UINT32                          uwDcrFreqNum;
    VOS_UINT16                          auhwGsmDcrFreqList[ UCOM_G_RX_GAIN0_DCR_CHAN_NUM ];
}UCOM_NV_GSM_RX_DCR_FREQ_LIST_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_RX_DC_OFFSET_GAIN0_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM DC Offset值
*****************************************************************************/
...
typedef struct
{
    VOS_UINT32                          uwGsmMainAntMask;                       /* 该值表示G模主集的BAND标识 */
    VOS_UINT32                          uwGsmMainAntExtMask;                    /* 该值表示G模主集扩展的BAND标识 */
    VOS_UINT32                          uwGsmDivAntMask;                        /* 该值表示G模分集的BAND标识 */
    VOS_UINT32                          uwGsmDivAntExtMask;                     /* 该值表示G模分集扩展的BAND标识 */
...
typedef struct
{
    ...
    VOS_UINT32                          uwTunerExtMask;                         /* Tuner新增的掩码 */
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_NCELL_RPT_MASK_PARA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 邻区信息上报屏蔽结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwNcellRptMaskFlag;                    /* GSM邻区信息上报屏蔽功能开关 */
    VOS_UINT16                          uhwSyncFailMaskTimes;                   /* GSM邻区同步失败信息屏蔽次数 */
    VOS_UINT16                          uhwTotalNcellNum;                       /* 当前邻区列表中小区的总个数(非服务区，并且能量大于-110dbm) */
    VOS_UINT16                          uhwSuccNcellNum;                        /* 当前邻区列表中同步成功的个数 */
}UCOM_NV_GSM_NCELL_RPT_MASK_PARA_STRU;
...
typedef struct
{
    ...
    VOS_INT16                           shwLOPowerAtten;                        /* LO Leakage校准时的功率回退值，单位为0.1dbm */
    VOS_INT16                           shwIQPowerAtten;                        /* IQ Imbalance校准时的功率回退值，单位为0.1dbm */
    VOS_INT16                           shwRsv;                                 /* 保留位 */
...
/*****************************************************************************
 结构名    : UCOM_NV_W_TX_CFR_COMP_INDEX_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : Cfr Comp
*****************************************************************************/
typedef struct
{
    VOS_INT8        acTxCfrCompIndex[UCOM_NV_W_TX_CFR_COMP_NUM];
    VOS_INT8        cRsv0;
    VOS_INT8        cRsv1;
    VOS_INT8        cRsv2;
}UCOM_NV_W_TX_CFR_COMP_INDEX_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_TX_CFR_COMP_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : Cfr Comp
*****************************************************************************/
typedef struct
{
    UCOM_NV_W_TX_CFR_COMP_INDEX_STRU    stCfrComp;
    UCOM_NV_W_TX_CFR_COMP_INDEX_STRU    stDpdCfrComp;
}UCOM_NV_W_TX_CFR_COMP_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_TAS_MAS_CTRL_WORD_STRU
 协议表格  :
 ASN.1描述 :
...
/*****************************************************************************
结构名    : UCOM_NV_W_CS_ANT2_ENERGY_CTRL_STRU
结构说明  :
对应NVID:
...
typedef struct
{
    VOS_UINT16                          uhwCsAnt2EnergyVoteSwitch;              /* 语音根据能量投票开关分集功能开关:0,不支持；1,支持 */
    VOS_INT16                           shwCsAnt2OpenRscpThd;                   /* 语音分集打开RSCP门限(默认值:-96*8),单位0.125db */
    VOS_INT16                           shwCsAnt2OpenEcn0Thd;                   /* 语音分集打开Ecn0门限(默认值:-12*8),单位0.125db */
    VOS_INT16                           shwCsAnt2CloseRscpThd;                  /* 语音分集关闭RSCP门限(默认值:-86*8),单位0.125db */
    VOS_INT16                           shwCsAnt2CloseEcn0Thd;                  /* 语音分集关闭Ecn0门限(默认值:-10*8),单位0.125db */
    VOS_INT16                           shwDpaEcn0ThdDelta;                     /* DPA时，Ecn0门限的delta值,默认为-2*8,单位0.125db */
}UCOM_NV_W_CS_ANT2_ENERGY_CTRL_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_W_SYNC_QIN_QOUT_THRES_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 同失步模块解调软判Qin Qout区间门限结构体
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwQin;                                 /* 解调软判门限Qin门限值 */
    VOS_UINT16                          uhwQout;                                /* 解调软判门限Qout门限值 */
}UCOM_NV_W_SYNC_THRES_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_SOFT_DEM_SYNC_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 同失步模块解调软判门限结构体
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwFeatureEnable;                       /* 同失步软化特性开关:关闭为0,打开为1 */
    VOS_UINT16                          uhwSyncBerThres;                        /* 同失步同步BER保护门限 */
    VOS_UINT16                          uhwOutOfSyncBerThres;                   /* 同失步失步BER保护门限 */
    VOS_UINT16                          uhwReserved;                            /* 保留 */
    UCOM_NV_W_SYNC_THRES_STRU           stFdpchSyncThres;                       /* FDPCH解调软判门限Qout,Qin门限值 */
    UCOM_NV_W_SYNC_THRES_STRU           astDpchSyncThres[UCOM_NV_W_SYNC_QIN_QOUT_THRES_NUM];
                                                                                /* 解调软判门限Qout,Qin门限值 */
}UCOM_NV_W_SOFT_DEM_SYNC_CTRL_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_RX_IQ_MISMATCH_CAL_RESULT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 主分集天线对应的Rx Iqmismatch校准结果
*****************************************************************************/
typedef struct
{
    UCOM_NV_GSM_RX_IQ_MISMATCH_STRU     stMainAntCalResult;                     /* 主集天线对应的Rx Iqmismatch校准结果 */
    UCOM_NV_GSM_RX_IQ_MISMATCH_STRU     stDivAntCalResult;                      /* 分集天线对应的Rx Iqmismatch校准结果 */
}UCOM_NV_GSM_RX_IQ_MISMATCH_CAL_RESULT_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_TX_IQ_SELF_CAL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :Tx 自校准NV
*****************************************************************************/
...
typedef struct
{
    ...
    VOS_UINT32                                  uwAntExtSwitch;                 /* 空闲时隙时天线新增的开关值 */
...
typedef struct
{
    ...
    VOS_UINT16                          auhwLutSwitchThreshold[UCOM_NV_DPD_LUT_THERSHOLD_MAX_NUM]; /* 切换门限,功率模式，单位0.1dB */
...
typedef struct
{
    VOS_UINT16                          auhwDpdStepV[UCOM_NV_DPD_LUT_MAX_NUM];  /* 支持2张DPD表 */
...
typedef struct
{
    VOS_INT32                           swDpdCompI  : 12; /* bit[0-11] : DPD补偿I路系数 */
    VOS_INT32                           swDpdCompQ  : 12; /* bit[12-23]: DPD补偿Q路系数 */
    VOS_INT32                           swReserved  : 8;  /* bit[24-31]: 保留 */
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : DPD LUT 每张表深度为128
*****************************************************************************/
typedef struct
{
    UCOM_NV_W_DPD_COMP_PARA_STRU        astDpdPara[UCOM_NV_DPD_LUT_MAX_LEN];    /* DPD表深度128 */
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : BBP接口提供4张DPD表，切换门限为5个，每张表深度为128,
             但目前只用到一张表，为节省空间，暂只定义两张表，门限保留，后续有需求再新增NV
*****************************************************************************/
typedef struct
{
    UCOM_NV_W_DPD_STEP_V_STRU           stDpdStepV;
    UCOM_NV_W_DPD_TABLE_STRU            astDpdLut[UCOM_NV_DPD_LUT_MAX_NUM]; /* 支持2张DPD表 */
}UCOM_NV_W_DPD_LUT_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_W_ET_LUT_POLY_COFF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ET LUT多项式系数
*****************************************************************************/
typedef struct
{
    VOS_INT16                           shwStartPower;                          /* 起始功率，单位0.1dB,默认40 */
    VOS_INT16                           shwVoltMvLowerLimit;                    /* 最小电压限制值，单位mv，默认800 */
    VOS_INT32                           aswHEtPolyCoff[4];                      /* 高档ET LUT多项式系数，数组下标0-3表示a0-a3
                                                                                  a3量化2^33,a2量化2^21,a1量化2^21,a0量化2^1；
                                                                                  即V(mv) = a3*P^3/2^33 + a2*P^2/2^21 + a1*P/2^21 + a0/2
                                                                                  其中P表示功率，单位0.1dB,有效值为【shwStartPower，shwStartPower+256】*/
    VOS_INT32                           aswMEtPolyCoff[4];                      /* 低档ET LUT多项式系数，量化关系，计算公式同上*/
}UCOM_NV_W_ET_LUT_POLY_COFF_STRU;

typedef UCOM_NV_W_ET_LUT_POLY_COFF_STRU UCOM_NV_CDMA_ET_LUT_POLY_COFF_STRU;
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : ET Time Delay频补控制
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwEtTimeDelayCalOnOff;                 /* 0:频补校准不使能,1: 频补校准使能 */
    VOS_UINT16                          uhwChannelNum;                          /* 每个Band信道有效个数 */
    VOS_UINT32                          auwFreqChan[UCOM_NV_ET_DELAY_FREQ_COMP_MAX_NUM];/* 绝对频率，单位100K，最多支持8个信道 */
...
typedef struct
{
    VOS_INT16                           ashwEtTimeDelayFreq[UCOM_NV_ET_DELAY_FREQ_COMP_MAX_NUM];/* Et 包络通路Delay频补，最多支持8个信道 */
...
/*****************************************************************************
 ...
 修改记录  :此NV16999原用于APM写NV通道测试,现已废弃不用,但保留结构定义,
            详见问题单:DTS2017032803321。
*****************************************************************************/
typedef struct
{
    /**
...
/*****************************************************************************
 ...
 修改记录  :此NV16998原用于APM写NV通道测试,现已废弃不用,但保留结构定义,
            详见问题单:DTS2017032803321。
*****************************************************************************/
typedef struct
{
...
typedef struct
{
    ...
    VOS_UINT16                          uhwEtDataPathIntDelay;                  /* 支持ET时数据通路延时 */

    VOS_UINT16                          uhwDataVlidOffTime;                     /* BBP TX数据有效指示，早于ABB拉低 */
    VOS_UINT16                          uhwDataVlidOnTime;                      /* BBP TX数据有效指示，高于ABB拉高 */
    VOS_UINT16                          uhwEtActEnDelay;                        /* apt_et_act_en提前上行时隙头生效时刻，单位为1/4chip */
    VOS_UINT16                          uhwResv;
...
typedef UCOM_NV_TX_IQ_SELF_CAL_STRU             UCOM_NV_CDMA_TX_IQ_SELF_CAL_STRU;          /* DC offset的直流校准门限 */
...
typedef struct
{
    ...
    VOS_UINT32                          uwRaPdCtrl      :1;                     /* 随机接入过程中， GSM PD打开使能，1:打开 */
    VOS_UINT32                          uwCsAB          :1;                     /* CS场景下AB，     GSM PD打开使能，1:打开 */
    VOS_UINT32                          uwCsSacch       :1;                     /* CS TCH/SACCH & SA4 & SA8场景下， GSM PD打开使能，1:打开 */
    VOS_UINT32                          uwCsTch         :1;                     /* CS TCH&SD4&SD8场景下，   GSM PD打开使能，1:打开 */
    VOS_UINT32                          uwPsPtcch       :1;                     /* PS PTCCH场景下， GSM PD打开使能，1:打开 */
    VOS_UINT32                          uwPsPdcch       :1;                     /* PS PDCCH场景下， GSM PD打开使能，1:打开 */
    VOS_UINT32                          uwNoSigTxBurst  :1;                     /* 非信令TX场景下， GSM PD打开使能，1:打开 */
    VOS_UINT32                          uwCloseTxAntFixFlag :1;                 /* 上行强配天线场景下，物理层关闭开关。0: 物理层不关闭，即AT命令发的上行强配天线功能生效 */
                                                                                /*                                     1: 物理层关闭，  即AT命令发的上行强配天线功能不生效。默认值为0 */
    VOS_UINT32                          uwReserve2      :19;
...
/*****************************************************************************
 结构名    : UCOM_NV_W_MAS_NON_DCH_MAS_CTRL_STRU
 协议表格  :
 结构说明  : TAS主控下非D态各态是否支持MAS功能NV
*****************************************************************************/
typedef struct
{
    VOS_UINT32                                  uwAccessMasEnable:2;            /* TAS主控下access态 MAS功能使能:1,代表使能;0,代表不使能;其它无效. 默认为0 */
    VOS_UINT32                                  uwIdleMasEnable:2;              /* TAS主控下idle态 MAS功能使能:1,代表使能;0,代表不使能;其它无效. 默认为0 */
    VOS_UINT32                                  uwSearchingMasEnable:2;         /* TAS主控下searching态 MAS功能使能:1,代表使能;0,代表不使能;其它无效. 默认为0 */
    VOS_UINT32                                  uwReserved:26;                  /* 保留 */
} UCOM_NV_W_MAS_NON_DCH_MAS_CTRL_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_MRX_FREQ_COMP_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MRX每档频补结构
*****************************************************************************/
typedef struct
{
    VOS_INT16                               ashwMrxGainFreqComp[UCOM_NV_MRX_GAIN_FREQ_COMP_NUM];
}UCOM_NV_MRX_FREQ_COMP_STRU;
...
typedef struct
{
    UCOM_NV_MRX_FREQ_COMP_STRU              stMrxGainFreqComp[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM];
}UCOM_NV_MRX_GAIN_FREQ_COMP_STRU;

typedef UCOM_NV_MRX_GAIN_FREQ_COMP_STRU  UCOM_NV_W_MRX_GAIN_FREQ_COMP_STRU;

typedef UCOM_NV_MRX_GAIN_FREQ_COMP_STRU  UCOM_NV_G_MRX_GAIN_FREQ_COMP_STRU;
...
typedef struct
{
    VOS_UINT16                              uhwDchGsdrEnFlag;                   /* 前台语音GSDR使能标志:0:不使能;1:使能 */
    VOS_UINT16                              uhwBackCallGsdrEnFlag;              /* 后台语音GSDR使能标志:0:不使能;1:使能 */
    VOS_UINT16                              uhwDchForceType;                    /* 前台语音强制启动 */
    VOS_UINT16                              uhwBackCallForceType;               /* 后台语音强制启动 */
    VOS_UINT16                              uhwSoftSwitchHardEnFlag;            /* 软基带切换硬基带使能标志. */
    VOS_UINT16                              uhwRsv;                             /* 预留后面增加控制变量. */

    VOS_UINT16                              uhwBchGsdrEnFlag;                   /* BCH态支持软基带标志 */
    VOS_UINT16                              uhwBchForceType;                    /* BCH态软基带强制译码类型 */
    VOS_UINT16                              uhwSearchGsdrEnFlag;                /* SEARCH态支持软基带标志 */
    VOS_UINT16                              uhwSearchForceType;                 /* SEARCH态软基带强制译码类型 */
    VOS_UINT16                              uhwTuningGsdrEnFlag;                /* TUNING态支持软基带标志 */
    VOS_UINT16                              uhwTuningForceType;                 /* TUNING态软基带强制译码类型 */

    VOS_INT16                               shwDchDaicOnRssiThreshold;          /* 启动ISAIC的Rssi门限   -90*/
    VOS_UINT16                              uhwDchDaicOnRssiPercent;            /* 低于启动ISAIC的Rssi门限次数比例 80% */
    VOS_INT16                               shwDchDaicOnCiThreshold;            /* 启动ISAIC的CI门限  3 */
    VOS_UINT16                              uhwDchDaicOnCiPercent;              /* 低于启动ISAIC的CI门限次数比例 80%  */
    VOS_UINT16                              uhwDchDaicOnQualThreshold;          /* 启动ISAIC的误码率门限 4% */
    VOS_UINT16                              uhwDchDaicOnQualTimes;              /* 超过启动ISAIC的误码率门限次数  3*/

    VOS_INT16                               shwDchDaicOffRssiThreshold;         /* 关闭ISAIC的Rssi门限   -80*/
    VOS_UINT16                              uhwDchDaicOffRssiPercent;           /* 高于关闭ISAIC的Rssi门限次数比例 80% */
    VOS_INT16                               shwDchDaicOffCiThreshold;           /* 关闭ISAIC的CI门限     10*/
    VOS_UINT16                              uhwDchDaicOffCiPercent;             /* 高于启动ISAIC的CI门限次数比例   80% */
    VOS_UINT16                              uhwDchDaicOffSubQualThreshold;      /* 关闭ISAIC的Sub帧误码率门限   1% */
    VOS_UINT16                              uhwDchDaicOffSubQualTimes;          /* 高于关闭ISAIC的Sub帧误码率门限次数 3 */

    VOS_INT16                               shwBchDaicOnRssiThreshold;          /* BCH态下判决启动DACI的RSSI门限 */
    VOS_UINT16                              uhwBchDaicOnPberThreshold;          /* BCH态下判决启动DACI的PBER门限 */
    VOS_INT16                               shwBchDaicOffRssiThreshold;         /* BCH态下判决关闭DACI的RSSI门限 */
    VOS_UINT16                              uhwBchDaicOffPberThreshold;         /* BCH态下判决关闭DACI的PBER门限 */
    VOS_INT16                               shwBchIsaicOffRssiThreshold;        /* BCH态下判决关闭ISAIC的RSSI门限 */
    VOS_UINT16                              uhwBchIsaicOffPbreThreshold;        /* BCH态下判决关闭ISAIC的PBER门限 */
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_GSDR_ALG_PARA_STRU
 协议表格  :
 结构说明  : GSDR算法相关参数
*****************************************************************************/
typedef struct
...
} UCOM_NV_GSM_GSDR_ALG_PARA_STRU;
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : ET Time Delay频补校准信道,频率值 boston and chica hase the same stru
*****************************************************************************/
typedef struct
{
...
typedef struct
{
    VOS_INT16           ashwEtTimeDelayFreq[UCOM_NV_CDMA_ET_DELAY_FREQ_COMP_MAX_NUM];
...
typedef UCOM_NV_CDMA_ET_TIME_DELAY_STRU UCOM_NV_CDMA_ET_TIME_DELAY_DEFAULT_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_TX_LOCK_ANT_TEST_CTRL_STRU
 协议表格  :
 结构说明  : TX 锁天线测试控制NV,不区分主副卡
*****************************************************************************/
typedef struct
{
    VOS_UINT32                                  uwGsmAntCtrl:1;                 /* G模锁天线控制,0:AT命令来控制锁定1:AT命令锁定不生效 */
    VOS_UINT32                                  uwWcdmaAntCtrl:1;               /* W模锁天线控制,0:AT命令来控制锁定1:AT命令锁定不生效 */
    VOS_UINT32                                  uwLteAntCtrl:1;                 /* L模锁天线控制,0:AT命令来控制锁定1:AT命令锁定不生效 */
    VOS_UINT32                                  uwTdsAntCtrl:1;                 /* T模锁天线控制,0:AT命令来控制锁定1:AT命令锁定不生效 */
    VOS_UINT32                                  uw1XAntCtrl:1;                  /* X模锁天线控制,0:AT命令来控制锁定1:AT命令锁定不生效 */
    VOS_UINT32                                  uwHrpdAntCtrl:1;                /* Hrpd模锁天线控制,0:AT命令来控制锁定1:AT命令锁定不生效 */
    VOS_UINT32                                  uwReserved0:1;                  /* 保留 */
    VOS_UINT32                                  uwReserved1:1;                  /* 保留 */
    VOS_UINT32                                  uwReserved2:24;                 /* 保留 */
} UCOM_NV_TX_LOCK_ANT_TEST_CTRL_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_W_CPICH_POWER_MODE_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : CPICH信道低功率模式控制
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwCpichLowPowerMode;               /* CPICH低功率模式，0:关闭，1:打开，默认关闭 */
    VOS_UINT16                              uhwReserved;                        /* 4字节对齐 */
}UCOM_NV_W_CPICH_POWER_MODE_CTRL_STRU;
/*****************************************************************************
 结构名    : NV_GSM_TX_IQ_MISMATCH_CAL_PARA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM Tx IQ Mismatch校准参数
*****************************************************************************/
typedef struct
{
    VOS_INT16                               shwTxRefPower;                      /* 校准时上行通道的功率，单位为0.1dbm */
    VOS_INT16                               shwLOPowerAtten;                    /* LO Leakage校准时的Dbb回退值，单位为0.1dbm */
    VOS_INT16                               shwIQPowerAtten;                    /* IQ Imbalance校准时的Dbb回退值，单位为0.1dbm */
    VOS_INT16                               shwRsv;                             /* 保留位 */
}NV_GSM_TX_IQ_MISMATCH_CAL_PARA_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_UC_ET_APT_MRX_GAIN_SETTING_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : UC ET Delay Mrx Gain纠正相关参数
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwUMrxGainModEn;                   /* U模Et校准前Mrx Gain修正使能 */
    VOS_INT16                               shwRsv1;                                 /* 保留位 */
    VOS_INT16                               shwUMrxAdcValue;                    /* U模Mrx修正计算过程的ADC值,单位为1dbm */
    VOS_UINT16                              uhwUStepThreshold;                  /* U模Step步进门限 */
    VOS_UINT16                              uhwCMrxGainModEn;                   /* C模Et校准前Mrx Gain修正使能 */
    VOS_INT16                               shwRsv2;                                 /* 保留位 */
    VOS_INT16                               shwCMrxAdcValue;                    /* C模Mrx修正计算过程的ADC值,单位为1dbm */
    VOS_UINT16                              uhwCStepThreshold;                  /* C模Step步进门限 */
}UCOM_NV_UC_ET_APT_MRX_GAIN_SETTING_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_TX_IQ_MISMATCH_CAL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :TX IQ MISMATCH校准初始功率和门限
*****************************************************************************/
...
/*****************************************************************************
 结构名    : UCOM_NV_W_MULTI_SEARCH_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : W多次搜网开关
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwNormalTempCtrlEnable;            /* 常温多次搜网开关，0:关闭，1:打开 */
    VOS_UINT16                              uhwReserved;                        /* 保留 */
}UCOM_NV_W_MULTI_SEARCH_CTRL_STRU;
