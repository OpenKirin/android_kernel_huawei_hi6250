...
#define PLATFORM_ID_BIT_KIRIN660     (5U)
...
static struct noc_platform_info g_noc_platform_info[] = {
	...
	/*hisi platform: kirin660 */
	[5] = {
	       .name = "kirin660",
	       .platform_id = 1 << PLATFORM_ID_BIT_KIRIN660,	/* must be same as the value defined in DTS. */
	       .p_noc_info_bus = noc_buses_info_kirin660,
	       .p_noc_info_dump = noc_dump_reg_list_kirin660,
	       .p_noc_info_filter_initflow = hisi_filter_initflow_kirin660,
	       .pfun_get_size = hisi_noc_get_array_size_kirin660,
	       .pfun_clock_enable = hisi_noc_clock_enable_kirin660,
	       }
};
