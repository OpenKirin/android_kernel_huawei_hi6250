...
static const ROUTE_ID_ADDR_STRU cfgsys_routeid_addr_tbl[] = {
	...
	{0x02, 0x21, 0x0, 0xe9840000},/*sysbus_service_target*/
	{0x02, 0x21, 0x1, 0x0},/*sysbus_service_target*/
	{0x02, 0x22, 0x0, 0xe98a0000},/*ufs_emmc_bus_service_target*/
};
...
struct noc_mid_info noc_mid_kirin660[] = {
	...
	{0, 12, 0x3F, 0x24, "DFC"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x16, "CIPHER"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x36, "HDLC"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x17, "CICOM0"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x37, "CICOM1"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x18, "BBE16_0"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x38, "BBE16_C"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x19, "BBP_DMA_0"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x39, "BBP_DMA_1"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x1A, "GU_BBP_MST_0"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x3A, "GU_BBP_MST_1"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x1B, "EDMA0"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x3B, "EDMA1"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x1C, "HARQ_L"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x3C, "HARQ_H"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x1D, "UPACC"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x3D, "RSR_ACC"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x1E, "CIPHER_WRITE_THOUGH"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x3F, "CCPU_CFG"},  /*noc_modem_mst*/
	{0, 12, 0x3F, 0x1F, "CCPU_L2C"},  /*noc_modem_mst*/
};

struct noc_sec_info noc_sec_kirin660[] = {
...
struct noc_dump_reg noc_dump_reg_list_kirin660[] = {
 ...
 */
const struct noc_busid_initflow hisi_filter_initflow_kirin660[] = {
...
const struct noc_bus_info noc_buses_info_kirin660[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_kirin660,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_kirin660),
		.p_noc_sec_info = noc_sec_kirin660,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_kirin660),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void hisi_noc_get_array_size_kirin660(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((NULL == bus_info_size)||(NULL == dump_list_size))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_kirin660);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_kirin660);
}
 ...
 */
unsigned int hisi_noc_clock_enable_kirin660(struct hisi_noc_device *noc_dev,
				     struct noc_node *node)
{
	void __iomem *reg_base = NULL;
