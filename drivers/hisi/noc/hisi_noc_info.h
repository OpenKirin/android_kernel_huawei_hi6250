...
extern const struct noc_bus_info noc_buses_info_kirin660[];
extern struct noc_mid_info noc_mid_kirin660[];
extern struct noc_dump_reg noc_dump_reg_list_kirin660[];
extern const struct noc_busid_initflow hisi_filter_initflow_kirin660[];
...
extern void hisi_noc_get_array_size_kirin970(unsigned int *bus_info_size,
					     unsigned int *dump_list_size);
extern void hisi_noc_get_array_size_kirin660(unsigned int *bus_info_size,
					     unsigned int *dump_list_size);
...
extern unsigned int hisi_noc_clock_enable_kirin970(struct hisi_noc_device
						   *noc_dev,
						   struct noc_node *node);
extern unsigned int hisi_noc_clock_enable_kirin660(struct hisi_noc_device
						   *noc_dev,
						   struct noc_node *node);
#endif
