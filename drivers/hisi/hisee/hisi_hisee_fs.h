...
#define HISEE_POWER_PROCESS_ID_ERROR    (-8000)
...
typedef struct _HISEE_IMG_HEADER {
	...
	unsigned int sw_version_cnt[HISEE_MAX_COS_IMAGE_NUMBER];
...
#define HISEE_ENCOS_SUB_FILE_MAX 4
...
typedef enum _HISEE_IMAGE_A_ACCESS_TYPE_ {
	...
	SW_COSID_RUN_READ_TYPE,
	SW_COSID_RUN_WRITE_TYPE,
...
typedef struct _COSIMAGE_VERSION_INFO_ {
	unsigned int magic;
	unsigned char img_version_num[HISEE_MAX_COS_IMAGE_NUMBER];
