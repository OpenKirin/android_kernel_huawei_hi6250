...
/** secure region 9.5M + 2M(dallas) **/
/* |~~~0x35280000~~~|~~~0x352b0000~~|~~~0x352ce000~~~|~~~0x356ce000~~~|~~~0x35700000~~~|~~~0x35c00000~~~~| */
/* |~OCRAM img bak~~|~~TCM img bak~~|~~~~IMG bak~~~~~|~~~sec reserve~~|~~HIFI RUNNING~~|EXPAND FOR DALLAS| */
/* |~~~~~~192K~~~~~~|~~~~~120k~~~~~~|~~~~~~~4M ~~~~~~|~~~~~200k~~~~~~~|~~~~~~~5M~~~~~~~|~~~~~2 M~~~~~~~~~| */
/* |~~~0x352affff~~~|~~~0x352cdfff~~|~~~0x356cdfff~~~|~~~0x356fffff~~~|~~~0x35bfffff~~~|~~~0x35dfffff~~~~| */
...
/* |~0x8BA22C00~|~~0x8BA31C00~~|~0x8BA40C00~|~0x8BA42C00~|~~0x8BA62C00~~~| */
/* |~~~OM DMA~~~|~soundtrigger~|~upload buf~|~usb share~~|~unsec reserve~| */
/* |~~~~~60K~~~~|~~~~~~60K~~~~~|~~~~~8k~~~~~|~~~~128k~~~~|~~~~~629k~~~~~~| */
/* |~0x8BA31BFF~|~~0x8BA40BFF~~|~0x8BA42BFF~|~0x8BA62BFF~|~~0x8BAFFFFF~~~| */
...
#define HIFI_UNSEC_RESERVE_SIZE             (0x9D400)
...
#define HIFI_UNSEC_RESERVE_ADDR         (HIFI_USB_DRIVER_SHARE_MEM_ADDR + HIFI_USB_DRIVER_SHARE_MEM_SIZE)
...
#else
#ifdef EXPAND_HIFI_RUNNING_REGION
#define HIFI_SEC_REGION_SIZE            (0xB80000)
#define HIFI_RUN_SIZE                   (0x700000)
#else
...
{
	USBAUDIO_SET_INTERFACE = 0,
	USBAUDIO_QUERY_CONTROLLER,
	USBAUDIO_MSG_MAX
};
