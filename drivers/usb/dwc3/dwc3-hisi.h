...
struct usb3_phy_ops {
	...
	int (*shared_phy_init)(struct hisi_dwc3_device *hisi_dwc3);
	...
	int (*clk_check)(struct hisi_dwc3_device *hisi_dwc3);
...
void hisi_usb_unreset_phy_if_fpga(struct hisi_dwc3_device *hisi_dwc3);
