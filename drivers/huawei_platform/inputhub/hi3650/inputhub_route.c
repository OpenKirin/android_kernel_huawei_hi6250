...
static int32_t vibrator_acc_data[3][3] = {};
			      ...
			      uint64_t timestamp)
{
	...
	if (TAG_FLUSH_META != tag) {
		...
		{
			memcpy(&vibrator_acc_data[vibrator_index++ % 3][0], (char *)&(sensor_batch_data->x),
							12);
		}
...
int is_vibrator_issue_gesture(void)
{
	...
	//judge_the_accel_date and do some work
	hwlog_info("vibor acc %d %d %d\n  %d %d %d \n %d %d %d\n", vibrator_acc_data[0][0], vibrator_acc_data[0][1]
		,vibrator_acc_data[0][2], vibrator_acc_data[1][0], vibrator_acc_data[1][1], vibrator_acc_data[1][2],
		vibrator_acc_data[2][0],vibrator_acc_data[2][1], vibrator_acc_data[2][2]);
	if(vibrator_acc_data[0][2] != 0 || vibrator_acc_data[1][2] != 0 || vibrator_acc_data[2][2] != 0)
	{
		if(vibrator_acc_data[0][2] < 700 && vibrator_acc_data[0][2] > -700
			&& vibrator_acc_data[1][2] < 700 && vibrator_acc_data[1][2] > -700
			&& vibrator_acc_data[2][2] < 700 && vibrator_acc_data[2][2] > -700)
		{
