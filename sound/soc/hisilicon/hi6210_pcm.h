...
struct hi6210_runtime_data
{
	...
	snd_pcm_uframes_t hw_ptr_interrupt_last; /* Position at interrupt time */
	enum HI6210_STATUS  status;       /* pcm status running or stop */
	struct snd_pcm_substream * substream;
	struct workqueue_struct *xrun_check_delay_wq;
	struct delayed_work xrun_check_delay_work;
#ifdef __DRV_AUDIO_MAILBOX_WORK__
