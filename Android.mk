...
KERNEL_PRODUCT_CONFIGS := $(shell pwd)/device/hisi/customize/config/${TARGET_ARM_TYPE}/$(TARGET_DEVICE)/${TARGET_PRODUCT}/product_config/kernel_config_slt
else
...
ifeq ($(kernel_sanitizer),undefined)
...
kernel_open_source_prebuild: $(GPIO_IOMUX_FILE) $(GENERATE_DTB) $(LCDKIT_EFFECT_FILE) $(LCD_EFFECT_FILE) $(KERNEL_CONFIG)
	@rm -frv $(KERNEL_GEN_CONFIG_PATH)
