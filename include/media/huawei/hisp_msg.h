...
typedef enum
{
    ...
    SUBCMD_SET_SOFTLIGHT_MODE = 150,

    SUBCMD_SET_PDALGO_ENABLE              = 151,
    SUBCMD_SET_PD_INFO                    = 152,
    SUBCMD_SET_SWPD_KEY                   = 153,
    SUBCMD_GET_SWPD_KEY                   = 154,
    SUBCMD_GET_SENSOR_COORD               = 155,
